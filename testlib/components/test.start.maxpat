{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 510.0, 289.0, 456.0, 313.0 ],
		"bglocked" : 0,
		"defrect" : [ 510.0, 289.0, 456.0, 313.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 125.0, 155.0, 20.0, 20.0 ],
					"presentation_rect" : [ 126.0, 154.0, 0.0, 0.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 39.5, 102.0, 134.5, 102.0 ],
					"source" : [ "obj-8", 0 ]
				}
