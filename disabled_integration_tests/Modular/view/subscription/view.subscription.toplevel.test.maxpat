...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 28.0, 111.001862, 281.0, 33.0 ],
									"text" : "j.test.assert.equal toplevel-test @input / @compareTo view.subscription.toplevel.test(view)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 28.0, 79.037781, 113.0, 20.0 ],
									"text" : "r namespace-result"
								}
