...
public:
		...
		mAudioSignal(NULL)
	{
		...
		obj0->mKernel.set(TT("linearGain"), 1.000000);
		obj0->mKernel.set(TT("maxNumChannels"), 0);
		obj0->mKernel.set(TT("midiGain"), 100.000000);
		obj0->mKernel.set(TT("gain"), 0.000000);
		obj0->mKernel.set(TT("bypass"), 0);
		obj0->mKernel.set(TT("mute"), 0);
		obj0->mKernel.set(TT("sampleRate"), 44100u);
		...
		obj1->mKernel.set(TT("maxNumChannels"), 0);
		obj1->mKernel.set(TT("operator"), TT("*"));
		obj1->mKernel.set(TT("operand"), 1.000000);
		obj1->mKernel.set(TT("bypass"), 0);
		obj1->mKernel.set(TT("mute"), 0);
		obj1->mKernel.set(TT("sampleRate"), 44100u);
		...
		obj2->mKernel.set(TT("frequency"), 440.000000);
		obj2->mKernel.set(TT("maxNumChannels"), 1);
		obj2->mKernel.set(TT("size"), 8192u);
		obj2->mKernel.set(TT("gain"), 0.000000);
		obj2->mKernel.set(TT("mode"), TT("sine"));
		obj2->mKernel.set(TT("interpolation"), TT("linear"));
		obj2->mKernel.set(TT("bypass"), 0);
		obj2->mKernel.set(TT("mute"), 0);
		obj2->mKernel.set(TT("sampleRate"), 44100u);

		audioObjectArguments.set(0, TT("operator"));
		audioObjectArguments.set(1, 1);
		audioObjectArguments.set(2, 1);
		TTObjectBaseInstantiate(TT("audio.object"), (TTObjectBasePtr*)&obj3, audioObjectArguments);
		obj3->mKernel.set(TT("maxNumChannels"), 0);
		obj3->mKernel.set(TT("operator"), TT("+"));
		obj3->mKernel.set(TT("operand"), 1.000000);
		obj3->mKernel.set(TT("bypass"), 0);
		obj3->mKernel.set(TT("mute"), 0);
		obj3->mKernel.set(TT("sampleRate"), 44100u);

		audioObjectArguments.set(0, TT("audio.sig"));
		audioObjectArguments.set(1, 1);
		audioObjectArguments.set(2, 1);
		TTObjectBaseInstantiate(TT("audio.object"), (TTObjectBasePtr*)&obj4, audioObjectArguments);
		obj4->mKernel.set(TT("value"), 110.000000);
		obj4->mKernel.set(TT("maxNumChannels"), 0);
		obj4->mKernel.set(TT("bypass"), 0);
		obj4->mKernel.set(TT("mute"), 0);
		obj4->mKernel.set(TT("sampleRate"), 44100u);


		TTObjectBaseInstantiate(TT("graph.object"), (TTObjectBasePtr*)&obj6, TTValue(TT("dataspace")));
		obj6->mKernel.set(TT("inputUnit"), TT("midi"));
		obj6->mKernel.set(TT("outputUnit"), TT("hz"));
		obj6->mKernel.set(TT("dataspace"), TT("time"));
		obj6->mKernel.set(TT("bypass"), 0);


		TTObjectBaseInstantiate(TT("graph.object"), (TTObjectBasePtr*)&obj7, TTValue(TT("midi.filter")));
		obj7->mKernel.set(TT("type"), TT("note"));
		obj7->mKernel.set(TT("bypass"), 0);


		TTObjectBaseInstantiate(TT("graph.object"), (TTObjectBasePtr*)&obj8, TTValue(TT("midi.in")));
		obj8->mKernel.set(TT("owner"), 135826496);
		obj8->mKernel.set(TT("bypass"), 0);
		obj8->mKernel.set(TT("device"), TT("default"));
	...
	obj6->connect(obj7);
		...
		obj9->mKernel.set(TT("maxNumChannels"), 0);
		obj9->mKernel.set(TT("operator"), TT("*"));
		obj9->mKernel.set(TT("operand"), 1.000000);
		obj9->mKernel.set(TT("bypass"), 0);
		obj9->mKernel.set(TT("mute"), 0);
		obj9->mKernel.set(TT("sampleRate"), 44100u);

		audioObjectArguments.set(0, TT("wavetable"));
		audioObjectArguments.set(1, 0);
		audioObjectArguments.set(2, 1);
		TTObjectBaseInstantiate(TT("audio.object"), (TTObjectBasePtr*)&obj10, audioObjectArguments);
		obj10->mKernel.set(TT("frequency"), 440.000000);
		obj10->mKernel.set(TT("maxNumChannels"), 1);
		obj10->mKernel.set(TT("size"), 8192u);
		obj10->mKernel.set(TT("gain"), 0.000000);
		obj10->mKernel.set(TT("mode"), TT("sine"));
		obj10->mKernel.set(TT("interpolation"), TT("linear"));
		obj10->mKernel.set(TT("bypass"), 0);
		obj10->mKernel.set(TT("mute"), 0);
		obj10->mKernel.set(TT("sampleRate"), 44100u);

		audioObjectArguments.set(0, TT("operator"));
		audioObjectArguments.set(1, 1);
		audioObjectArguments.set(2, 1);
		TTObjectBaseInstantiate(TT("audio.object"), (TTObjectBasePtr*)&obj11, audioObjectArguments);
		obj11->mKernel.set(TT("maxNumChannels"), 0);
		obj11->mKernel.set(TT("operator"), TT("*"));
		obj11->mKernel.set(TT("operand"), 1.000000);
		obj11->mKernel.set(TT("bypass"), 0);
		obj11->mKernel.set(TT("mute"), 0);
		obj11->mKernel.set(TT("sampleRate"), 44100u);
		...
		obj12->mKernel.set(TT("value"), 10.000000);
		obj12->mKernel.set(TT("maxNumChannels"), 0);
		obj12->mKernel.set(TT("bypass"), 0);
		obj12->mKernel.set(TT("mute"), 0);
		obj12->mKernel.set(TT("sampleRate"), 44100u);
		...
		obj16->mKernel.set(TT("maxNumChannels"), 0);
		obj16->mKernel.set(TT("operator"), TT("*"));
		obj16->mKernel.set(TT("operand"), 1.000000);
		obj16->mKernel.set(TT("bypass"), 0);
		obj16->mKernel.set(TT("mute"), 0);
		obj16->mKernel.set(TT("sampleRate"), 44100u);
		...
		obj17->mKernel.set(TT("sustain"), -12.000000);
		obj17->mKernel.set(TT("release"), 500.000000);
		obj17->mKernel.set(TT("maxNumChannels"), 0);
		obj17->mKernel.set(TT("sampleRate"), 44100u);
		obj17->mKernel.set(TT("attack"), 150.000000);
		obj17->mKernel.set(TT("mode"), TT("hybrid"));
		obj17->mKernel.set(TT("trigger"), 0);
		obj17->mKernel.set(TT("decay"), 150.000000);
		obj17->mKernel.set(TT("mute"), 0);
		obj17->mKernel.set(TT("linearSustain"), 0.251189);
		obj17->mKernel.set(TT("bypass"), 0);
		...
		obj23->mKernel.set(TT("sustain"), -6.000000);
		obj23->mKernel.set(TT("release"), 500.000000);
		obj23->mKernel.set(TT("maxNumChannels"), 0);
		obj23->mKernel.set(TT("sampleRate"), 44100u);
		obj23->mKernel.set(TT("attack"), 50.000000);
		obj23->mKernel.set(TT("mode"), TT("hybrid"));
		obj23->mKernel.set(TT("trigger"), 0);
		obj23->mKernel.set(TT("decay"), 100.000000);
		obj23->mKernel.set(TT("mute"), 0);
		obj23->mKernel.set(TT("linearSustain"), 0.501187);
		obj23->mKernel.set(TT("bypass"), 0);
