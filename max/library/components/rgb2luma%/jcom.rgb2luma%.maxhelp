{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 158.0, 66.0, 617.0, 546.0 ],
		"bglocked" : 0,
		"defrect" : [ 158.0, 66.0, 617.0, 546.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 533.0, 518.0, 72.0, 17.0 ],
					"presentation_rect" : [ 560.0, 527.0, 0.0, 0.0 ],
					"text" : "jit.rgb2luma"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jcom.rgb2luma%", "@description", "Check and convert rgb to monochrom matrix if necessary" ],
					"bgmode" : 1,
					"id" : "obj-22",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.0, 498.0, 54.0, 19.0 ],
					"text" : "see also:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 434.0, 538.0, 74.0, 19.0 ],
					"text" : "prepend help"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 434.0, 518.0, 95.0, 17.0 ],
					"text" : "jcom.luma2rgb%"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 434.0, 560.0, 49.0, 19.0 ],
					"text" : "pcontrol"
				}
