{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 562.0, 44.0, 525.0, 587.0 ],
		"bglocked" : 0,
		"defrect" : [ 562.0, 44.0, 525.0, 587.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "@name", "jcom.luma2rgb%", "@description", "Convert from greyscale to color" ],
					"bgmode" : 1,
					"id" : "obj-22",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 403.0, 538.0, 58.0, 19.0 ],
					"text" : "see also:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 403.0, 579.0, 78.0, 19.0 ],
					"text" : "prepend help"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 403.0, 558.0, 106.0, 17.0 ],
					"text" : "jcom.rgb2luma%"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 403.0, 602.0, 55.0, 19.0 ],
					"text" : "pcontrol"
				}
