...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 176.0, 85.0, 77.0, 31.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 186.0, 85.0, 111.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 143.0, 185.0, 73.0, 19.0 ],
					"text" : "t view/panel"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 119.0, 125.0, 67.0, 55.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 234.0, 162.0, 62.0, 44.0 ],
					"rounded" : 8.0,
					"text" : "more parameter",
					"truncate" : 0,
					"varname" : "panelButton"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 185.0, 90.0, 77.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 231.0, 125.0, 29.0, 19.0 ],
					"text" : "Out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 185.0, 70.0, 77.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 231.0, 105.0, 21.0, 19.0 ],
					"text" : "In"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Number of AU output signals",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-14",
					"maxclass" : "number",
					...
					"presentation" : 1,
					"presentation_rect" : [ 263.0, 125.0, 33.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					"annotation" : "Number of AU input signals.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-39",
					"maxclass" : "number",
					...
					"presentation" : 1,
					"presentation_rect" : [ 263.0, 105.0, 33.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					"annotation" : "Load an AU plugin. must work with 2 audio ins and 2 audio outs.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-23",
					"items" : "<empty>",
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 39.0, 444.0, 132.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 24.0, 469.0, 127.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 25.0, 414.0, 46.0, 19.0 ],
													"text" : "sel 0 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 73.0, 414.0, 149.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 621.0, 365.0, 155.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 161.0, 215.0, 196.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.0, 235.0, 137.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.0, 235.0, 32.0, 17.0 ],
					"text" : "/init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 345.0, 26.0, 26.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 220.0, 345.0, 185.0, 19.0 ],
					"text" : "----multicable inputs----"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 665.0, 26.0, 26.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 122.0, 671.0, 151.0, 19.0 ],
					"text" : "---multicable outputs---"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 170.5, 258.0, 39.5, 258.0 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 195.5, 258.0, 39.5, 258.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 340.5, 258.0, 39.5, 258.0 ],
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 152.5, 258.5, 39.5, 258.5 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jalg.sur.audiounit~.maxpat",
				"bootpath" : "/Users/lossius/dev/Jamoma/Modules/Modular/Max/modules/spatialization/sur.audiounit~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
