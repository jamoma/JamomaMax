...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 497.0, 111.0, 97.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 201.0, 348.0, 76.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 169.0, 301.0, 92.0, 21.0 ],
					"text" : "r #0__setting"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 757.0, 439.0, 28.0, 19.0 ],
					"text" : "t 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 983.0, 568.0, 49.0, 19.0 ],
					"text" : "* 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 827.0, 484.0, 49.0, 19.0 ],
					"text" : "* 0.001"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 603.0, 255.0, 24.0, 19.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 603.0, 233.0, 64.0, 19.0 ],
					"text" : "change 0 -"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 497.0, 142.0, 129.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 768.0, 362.0, 112.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 542.0, 312.0, 92.0, 19.0 ],
					"text" : "r #0__xxx_done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 827.0, 463.0, 35.0, 19.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 684.0, 363.0, 68.0, 19.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 201.0, 23.0, 48.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 200.0, 33.0, 45.0, 19.0 ],
					"text" : "elapse:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 261.0, 24.0, 35.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 253.0, 33.0, 34.0, 19.0 ],
					"text" : "loop:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 684.0, 388.0, 73.0, 19.0 ],
					"text" : "prepend text"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 459.0, 56.0, 39.0, 21.0 ],
					"text" : "loop",
					"textcolor" : [ 0.290196, 0.611765, 0.380392, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 551.0, 244.0, 39.0, 21.0 ],
					"text" : "play",
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 800.0, 359.0, 468.25, 359.0, 468.25, 227.0, 612.5, 227.0 ],
					"source" : [ "obj-48", 1 ]
				}
...
, 			{
				...
				"bootpath" : "/Users/lossius/dev/Jamoma/Modules/Modular/Max/modules/spatialization/sur.input~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
