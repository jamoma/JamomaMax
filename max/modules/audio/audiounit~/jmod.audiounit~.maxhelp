{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 471.0, 44.0, 662.0, 726.0 ],
		"bglocked" : 0,
		"defrect" : [ 471.0, 44.0, 662.0, 726.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 239.0, 178.0, 17.0 ],
					"text" : "/parameter/resonance:/value/inc"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.audiounit~", "@description", "AudioUnit plug-ins hosting module" ],
					"bgmode" : 1,
					"id" : "obj-6",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 346.023804, 233.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 313.738098, 201.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 292.452393, 200.0, 19.0 ],
					"text" : "1) Load an AU plugin."
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 232.0, 44.0, 400.0, 366.0 ],
						"bglocked" : 0,
						"defrect" : [ 232.0, 44.0, 400.0, 366.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 220.0, 230.0, 17.0 ],
					"text" : "/parameter/cutoff/frequency $1 ramp 3000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 530.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 258.0, 211.0, 31.0 ],
					"text" : "All AU parameters can be ramped. Do the following to test:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 145.44606, 273.0, 31.0 ],
					"text" : "jmod.audiounit~ creates a dynamic namespace depending on the parameters of the plug-in loaded."
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"hidden" : 0,
					"midpoints" : [ 34.5, 492.0, 299.5, 492.0 ],
					"source" : [ "obj-17", 0 ]
				}
