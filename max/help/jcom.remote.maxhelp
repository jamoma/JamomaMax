...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 328.0, 186.0, 150.0, 20.0 ],
									"text" : "TODO"
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 169.0, 183.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 169.0, 221.0, 162.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 597.0, 81.0, 44.0, 19.0 ],
					"text" : "TODO"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 169.0, 341.0, 150.0, 19.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jcom.remote", "@description", "remote control and listening to a parameter|message|return" ],
					"bgmode" : 1,
					"embed" : 1,
					"id" : "obj-2",
					"maxclass" : "bpatcher",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 0.0, 0.0, 94.0, 29.0 ],
									"text" : "com.view",
									"textcolor" : [ 0.4, 0.4, 0.4, 1.0 ],
									"varname" : "name[1]"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 48.0, 19.0, 94.0, 29.0 ],
									"text" : "com.view",
									"textcolor" : [ 0.4, 0.4, 0.4, 1.0 ],
									"varname" : "name"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 48.0, 39.0, 299.0, 19.0 ],
									"text" : "remote control and listening to a parameter|message|return",
									"textcolor" : [ 0.62, 0.0, 0.36, 1.0 ],
									"varname" : "description"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-34",
									"ignoreclick" : 1,
									"items" : [ ",", "Launch html reference page for jcom.remote", ",", "Launch Jamoma overview patch", ",", "Credits and acknowledgements", ",", "Show the bug tracker entries for jcom.remote", ",", "How to report a bug?", ",", "Paypal donation via pledgie.com" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 148.0, 243.0, 153.0, 32.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 195.0, 123.0, 212.0, 43.0 ],
									"text" : "patcherargs @name jcom.module @description \"A module which does a lot of cool things\""
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 1,
									"midpoints" : [ 157.5, 294.5, 106.5, 294.5 ],
									"source" : [ "obj-14", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 1,
									"midpoints" : [ 397.5, 190.0, 332.5, 190.0 ],
									"source" : [ "obj-5", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 1,
									"midpoints" : [ 332.5, 236.5, 157.5, 236.5 ],
									"source" : [ "obj-7", 0 ]
								}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 178.5, 387.0, 156.0, 387.0, 156.0, 336.0, 178.5, 336.0 ],
					"source" : [ "obj-10", 0 ]
				}
