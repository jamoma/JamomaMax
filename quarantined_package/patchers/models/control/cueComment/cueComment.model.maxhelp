...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "@description", "Displays annotations stored with cues" ],
					"bgmode" : 1,
					"id" : "obj-4",
					"maxclass" : "bpatcher",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 550.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 169.0, 90.0, 269.0, 19.0 ],
					"text" : "Refer to the jmod.cueManager for further details:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.0, 120.0, 100.0, 17.0 ],
