{
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"hint" : "turn on/off sending",
					"id" : "obj-42",
					"maxclass" : "toggle",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 328.0, 565.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 253.0, 128.0, 18.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 348.0, 529.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 254.0, 27.0, 18.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 4.0, 463.0, 54.0, 19.0 ],
					"text" : "route set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 73.0, 227.0, 68.0, 19.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "clear" ],
					"patching_rect" : [ 22.0, 251.0, 48.0, 19.0 ],
					"text" : "t clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 4.0, 483.0, 44.0, 19.0 ],
					"text" : "sel null"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 133.0, 366.0, 27.0, 17.0 ],
					"text" : "null"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 133.0, 344.0, 51.0, 19.0 ],
					"text" : "sel bang"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 662.0, 96.0, 600.0, 426.0 ],
						"bglocked" : 0,
						"defrect" : [ 662.0, 96.0, 600.0, 426.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 83.0, 127.0, 24.0, 19.0 ],
									"text" : "t b"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 24.0, 119.0, 50.0, 19.0 ],
									"text" : "t b clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 50.0, 76.0, 51.0, 19.0 ],
									"text" : "sel bang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 113.0, 128.0, 68.0, 19.0 ],
									"text" : "prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 84.0, 98.0, 54.0, 19.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 50.0, 58.0, 19.0 ],
									"text" : "route text"
								}
...
,
					"patching_rect" : [ 133.0, 279.0, 30.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 169.0, 364.0, 54.0, 19.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 133.0, 324.0, 58.0, 19.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "int", "", "" ],
					"patching_rect" : [ 132.0, 257.0, 88.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter multicast/port @range 1 9999 @clipmode low @type integer @description \"Set the network port number used for sending out multicast Open Sound Control messages.\"",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 379.0, 377.0, 35.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 378.0, 304.0, 54.0, 19.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 378.0, 284.0, 58.0, 19.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "int", "", "" ],
					"patching_rect" : [ 256.0, 318.0, 112.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 796.0, 80.0, 65.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 873.0, 55.0, 74.0, 17.0 ],
					"text" : "offset 0 -120"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 796.0, 55.0, 67.0, 17.0 ],
					"text" : "offset 0 -19"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 796.0, 33.0, 162.0, 19.0 ],
					"text" : "sel single multicast"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 367.0, 21.0, 54.0, 19.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 367.0, 1.0, 58.0, 19.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 378.0, 123.0, 35.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter send/port @type integer @range 1 9999 @clipmode low @description \"Set the network port number used for sending out Open Sound Control messages.\"",
					"varname" : "send_port"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 27.0, 69.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 27.0, 69.0, 19.0 ],
					"text" : "receive port"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter receive/port @type integer @range 1 9999 @clipmode low @description \"Set the network port number on which to receive Open Sound Control messages.\"",
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 387.5, 444.0, 376.0, 444.0, 376.0, 372.0, 388.5, 372.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 390.5, 278.0, 366.0, 278.0, 366.0, 204.0, 390.5, 204.0 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 386.5, 197.0, 362.0, 197.0, 362.0, 120.0, 387.5, 120.0 ],
					"source" : [ "obj-43", 0 ]
				}
