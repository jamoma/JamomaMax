...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.0, 31.0, 61.0, 19.0 ],
									"text" : "pipe 2000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 70.0, 10.0, 56.0, 19.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.0, 52.0, 170.0, 29.0 ],
									"text" : "feedforward 0.9, feedback 0.4, bleed 0.38"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 41.0, 170.0, 157.0, 17.0 ],
									"text" : "/bleed 0.38"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 39.0, 208.0, 320.0, 240.0 ]
								}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "spectrogram~.module.maxpat",
				"bootpath" : "/Users/WALL-E/Documents/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/spectrogram~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				...
				"bootpath" : "/Users/WALL-E/Documents/Jamoma/Implementations/Max/Jamoma/patchers/components/luma2rgb%",
