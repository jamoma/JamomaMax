{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 62.0, 344.0, 847.0, 448.0 ],
		"bglocked" : 0,
		"defrect" : [ 62.0, 344.0, 847.0, 448.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 195.0, 285.0, 70.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 100.0, 108.0, 70.0, 21.0 ],
					"text" : "saturation",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 120.0, 345.0, 64.0, 21.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 371.0, 43.0, 19.0 ],
					"text" : "set 1."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 111.0, 259.0, 17.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 310.0, 89.0, 19.0 ],
					"text" : "saturation $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 370.0, 100.0, 19.0 ],
					"text" : "j.send"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 470.0, 210.0, 145.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 145.0, 0.0, 115.0, 19.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 345.0, 275.0, 126.0, 19.0 ],
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 345.0, 310.0, 100.0, 19.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"id" : "obj-4",
					"items" : [ "/cueManager", ",", "/output~", ",", "/input~", ",", "/degrade~" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 1.0, 37.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 762.0, 107.0, 480.0, 416.0 ],
						"bglocked" : 0,
						"defrect" : [ 762.0, 107.0, 480.0, 416.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 91.0, 150.0, 38.0, 19.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 102.0, 116.0, 34.0, 19.0 ],
									"text" : "t b 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 106.0, 94.0, 52.0, 19.0 ],
									"text" : "route 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 14.0, 179.0, 96.0, 19.0 ],
									"text" : "gate 2"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 139.0, 116.0, 46.0, 19.0 ],
									"text" : "t b i 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 91.0, 248.0, 103.0, 19.0 ],
									"text" : "sprintf %s.%s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 108.0, 72.0, 14.0, 14.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 88.0, 23.0, 15.0, 15.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 97.0, 57.5, 199.5, 57.5 ],
									"source" : [ "obj-25", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 311.5, 225.0, 184.5, 225.0 ],
									"source" : [ "obj-23", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 199.5, 174.0, 23.5, 174.0 ],
									"source" : [ "obj-17", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-17", 0 ],
									"hidden" : 0,
									"midpoints" : [ 126.5, 149.0, 199.5, 149.0 ],
									"source" : [ "obj-28", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-21", 0 ],
									"hidden" : 0,
									"midpoints" : [ 148.5, 222.0, 100.5, 222.0 ],
									"source" : [ "obj-19", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-21", 1 ],
									"hidden" : 0,
									"midpoints" : [ 162.0, 225.0, 184.5, 225.0 ],
									"source" : [ "obj-19", 1 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 335.0, 169.0, 19.0 ],
