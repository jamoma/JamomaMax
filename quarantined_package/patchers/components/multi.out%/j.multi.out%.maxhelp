{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 52.0, 71.0, 547.0, 446.0 ],
		"bglocked" : 0,
		"defrect" : [ 52.0, 71.0, 547.0, 446.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "@name", "j.multi.out%", "@description", "Split video signals from a multicable" ],
					"bgmode" : 1,
					"id" : "obj-19",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 327.0, 305.0, 80.0, 60.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 120.5, 285.5, 209.5, 285.5 ],
					"source" : [ "obj-11", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 39.5, 294.5, 119.5, 294.5 ],
					"source" : [ "obj-11", 0 ]
				}
