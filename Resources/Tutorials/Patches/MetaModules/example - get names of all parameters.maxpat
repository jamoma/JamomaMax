{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 91.0, 80.0, 792.0, 642.0 ],
		"bglocked" : 0,
		"defrect" : [ 91.0, 80.0, 792.0, 642.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 100.0, 400.0, 100.0, 19.0 ],
					"presentation_rect" : [ 99.0, 401.0, 0.0, 0.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 205.0, 225.0, 150.0, 19.0 ],
					"presentation_rect" : [ 209.0, 208.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"id" : "obj-10",
					"items" : [ "/demo_degrade~", ",", "/demo_filter~", ",", "/echo~", ",", "/input~", ",", "/output~" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 100.0, 225.0, 100.0, 19.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 365.0, 45.0, 234.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 365.0, 260.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.0, 375.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 365.0, 75.0, 300.0, 140.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 140.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 150.0, 282.0, 109.5, 282.0 ],
					"source" : [ "obj-10", 1 ]
				}
