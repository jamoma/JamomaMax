{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 18.0, 354.0, 1262.0, 479.0 ],
		"bglocked" : 0,
		"defrect" : [ 18.0, 354.0, 1262.0, 479.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 200.0, 390.0, 81.0, 19.0 ],
					"text" : "peakamp~ 50",
					"varname" : "left[4]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 55.0, 80.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter~ feedback @type decimal @range/bounds 0. 1. @clipmode both @ramp/drive scheduler @repetitions/filter 1 @description \"Delay feedback\"",
					"varname" : "cf[1]"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter maxdelay @type decimal @ramp/drive scheduler @repetitions/filter 1 @range/bounds 0 100000 @clipmode both @description \"Maximum Delay time in milliseconds for left channel.\"",
					"varname" : "left[1]"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter delay @type decimal @ramp/drive scheduler @repetitions/filter 1 @range/bounds 0 10000 @clipmode both @description \"Delay time in milliseconds for left channel.\"",
					"varname" : "left"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 64.5, 101.5, 119.5, 101.5 ],
					"source" : [ "obj-6", 0 ]
				}
