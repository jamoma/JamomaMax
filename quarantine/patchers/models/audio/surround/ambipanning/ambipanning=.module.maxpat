...
, 			{
				"box" : 				{
					...
					"text" : "ambipanning=.model #1"
				}

			}
, 			{
				"box" : 				{
					"annotation" : "ICST Ambipanning for multiple sources for multiple speakers.",
					"args" : [ "#1" ],
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					"name" : "ambipanning=.view.maxpat",
					"numinlets" : 2,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "ambipanning=.view.maxpat",
				"bootpath" : "/Users/jln/@Jamoma/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/surround/ambipanning=",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
