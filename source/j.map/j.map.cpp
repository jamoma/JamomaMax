...
int TTCLASSWRAPPERMAX_EXPORT main(void)
{
	...
	return wrapTTModularClassAsMaxClass(kTTSym_Mapper, "j.map", NULL, spec);
}
...
void map_subscribe(TTPtr self)
{
	...
	/* TODO : fix exposeAttribute as parameter because for now
	 ...
	 if (!jamoma_subscriber_create((t_object*)x, x->wrappedObject, x->address, &x->subscriberObject, returnedAddress, &returnedNode, &returnedContextNode)) {
