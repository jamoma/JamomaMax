...
{   
	...
	c = class_new("j.vimic~", (method)vimic_new, (method)vimic_free, sizeof(t_vimic), (method)0L, A_GIMME, 0);	
...
void vimic_dsp(t_vimic *x, t_signal **sp, short *count)
{
    ...
    if (num_args < 4 || num_args > 147) 
        post( "j.vimic~ : Combination of Reflection Order and Channels not supported" );
