...
/**
 */
TTErr		makeInternals_data(TTPtr self, TTAddress address, TTSymbol name, t_symbol* callbackMethod, TTPtr context, TTSymbol service, TTObjectBasePtr *returnedData, TTBoolean deferlow = NO);
TTErr		makeInternals_explorer(TTPtr self, TTSymbol name, t_symbol* callbackMethod, TTObjectBasePtr *returnedExplorer, TTBoolean deferlow = NO);


/**
 */
TTErr		makeInternals_viewer(TTPtr self, TTAddress address, TTSymbol name, t_symbol* callbackMethod, TTObjectBasePtr *returnedViewer, TTBoolean deferlow = NO);


/**
 */
TTErr		makeInternals_receiver(TTPtr self, TTAddress address, TTSymbol name, t_symbol* callbackMethod, TTObjectBasePtr *returnedReceiver, TTBoolean deferlow = NO, TTBoolean appendNameAsAttribute = NO);
