...
/** The Hub. j.hub performs a large part of the automagic part of Jamoma.  This includes things such as saving and recalling presets, resizing modules to one of the standard sizes forwarding of control messages to j.in and so on.  */
typedef struct _hub{							///< Data Structure for this object
	...
	t_object		*in_object;					///< cache the j.in object directly for quick access
	t_object		*out_object;				///< cache the j.out object directly for quick access
	t_object		*meter_object[MAX_NUM_CHANNELS];	///< cache any meter objects so they can be handed to j.out
	t_object		*gui_object;				///< cache the j.remote object in the gui for quick access
	...
	t_object		*jcom_send;					///< j.send and j.receive objects for remote communication
...
/** Re-examin the patch that j.hub is part of and refresh the list of Jamoma core objects subscribed to this hub.
...
/** This is called by clients who wish to register their parameters with the hub.  Meaning these are typically called by j.parameter 
...
/** Receive parameter values from j.parameter.
 @param x			Pointer to this object
...
/** Receive private messages from j.remote.
 @param x			Pointer to this object
 @param name		Name of the parameter that is sending a message.
 @param argc		The number of arguments to the message.
 @param argv		The arguments as a pointer to an array of atoms.
...
/** Receive messages from j.return - don't send messages back to the algorithm.
 @param x			Pointer to this object
 @param name		Name of the parameter that is sending a message.
 @param argc		The number of arguments to the message.
 @param argv		The arguments as a pointer to an array of atoms.
...
/** Get the names of all j.parameter objects subscribed to the hub.
 @param x			Pointer to this object.
 */
void		hub_paramnames_get(t_hub *x);


/** Get the names of all j.message objects subscribed to the hub.
 @param x			Pointer to this object.
 */
void		hub_messagenames_get(t_hub *x);


/** Get the names of all j.return objects subscribed to the hub.
 @param x			Pointer to this object.
 */
...
/** Get the names of all j.parameter, j.message and j.return objects subscribed to the hub.
 @param x			Pointer to this object.
 */
...
/** Get a linked list of parameters subscribed to the hub.
 @param x			Pointer to this object.
 @param linklist	The j.parameter objects of the module.
 */
...
/** Get a linked list of messages subscribed to the hub.
 @param x			Pointer to this object.
 @param linklist	The j.message objects of the module.
 */
...
/** Get a linked list of returns subscribed to the hub.
 @param x			Pointer to this object.
 @param linklist	The j.return obejcts of the module.
 */
...
/** Returns the name of the module.  Only really used by j.core.cpp.
...
/** Initializes any j.init objects that are subscribed to the hub by sending them
 * a 'bang'.
 * @param x the hub who's subscribed j.init objects should be banged
 */
...
/** Receive messages from our internal j.receive external.
 * @param x			Pointer to this object.
 * @param msg		The message received.
...
// These are in j.hub.autodoc.cpp
...
// These are in j.hub.internals.cpp
...
// These are in j.hub.presets.cpp
