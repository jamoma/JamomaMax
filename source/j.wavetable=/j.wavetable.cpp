...
t_max_err		OscilSetGain(OscilPtr self, void* attr, long argc, t_atom* argv);
t_max_err		OscilSetNumChannels(OscilPtr self, void* attr, long argc, t_atom* argv);


// Globals
static t_class* sOscilClass;
