{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 36.0, 44.0, 416.0, 436.0 ],
		"bglocked" : 0,
		"defrect" : [ 36.0, 44.0, 416.0, 436.0 ],
...
,
					"patching_rect" : [ 29.0, 293.0, 47.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 454.0, 44.0, 340.0, 435.0 ],
						"bglocked" : 0,
						"defrect" : [ 454.0, 44.0, 340.0, 435.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
									...
									"patcher" : 									{
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 104.0, 98.0, 19.0 ],
													"text" : "pack"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 138.0, 75.0, 93.0, 19.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 127.0, 85.0, 19.0 ],
													"text" : "prepend notein"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 50.0, 75.0, 93.0, 19.0 ],
													"text" : "scale 0. 1. 0 127"
												}
...
,
									"patching_rect" : [ 17.0, 172.0, 77.0, 19.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"fontname" : "Verdana",
										"default_fontname" : "Verdana",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 17.0, 270.0, 300.0, 140.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 17.0, 196.0, 300.0, 70.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 19.0, 55.0, 267.0, 31.0 ],
...
,
					"patching_rect" : [ 293.0, 118.0, 52.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontname" : "Verdana",
						"default_fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 208.0, 148.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 223.0, 364.0, 68.0, 19.0 ],
					"text" : "Dreaminess"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 177.0, 84.0, 19.0 ],
					"text" : "Turn mouse on"
				}
