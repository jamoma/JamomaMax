...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 399.5, 23.0, 46.0, 19.0 ],
					"style" : "",
					"text" : "shade"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 3.0, 103.0, 27.0 ],
					"style" : "",
					"text" : "View shade"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 364.5, 20.5, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 364.5, 56.0, 57.0, 21.0 ],
					"style" : "",
					"text" : "select 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.5, 137.0, 146.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 383.5, 93.0, 140.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 364.5, 191.0, 66.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 37.0, 300.0, 175.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 393.0, 178.0, 374.0, 178.0 ],
					"source" : [ "obj-4", 0 ]
				}
		...
		"parameters" : 		{
			...
			"obj-7::obj-1::obj-55" : [ "Master Gain[1]", "Master Gain", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "input~.module.maxpat",
