...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 137.0, 150.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 39.0, 253.0, 31.0 ],
					"style" : "",
					"text" : "It is possible to use Jamoma as an engine, and make an independent GUI for controlling it."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 74.0, 240.0, 43.0 ],
					"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 8.0, 288.0, 135.25, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 8.0, 232.0, 251.5, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "signal", "signal", "" ],
									"patching_rect" : [ 192.0, 144.0, 116.0, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 8.0, 77.5, 115.0, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 192.0, 77.5, 121.0, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 192.0, 114.0, 67.0, 21.0 ],
									"style" : "",
									"text" : "source pink"
								}
...
,
									"patching_rect" : [ 8.0, 114.0, 77.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 8.0, 41.0, 270.0, 31.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 8.0, 7.0, 70.0, 28.0 ],
									"style" : "",
									"text" : "Engine"
								}
...
,
					"patching_rect" : [ 254.0, 85.0, 52.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Verdana",
...
,
		...
		"parameters" : 		{
			...
			"obj-5::obj-14" : [ "live.numbox[6]", "live.numbox", 0 ],
			...
			"obj-7::obj-12::obj-6" : [ "live.text[12]", "live.text", 0 ],
