...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 25.0, 195.0, 44.0 ],
					"style" : "",
					"text" : "j.in~ & j.out~"
				}
...
,
					"patching_rect" : [ 27.0, 147.0, 738.0, 554.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-11" : [ "Ratio", "Ratio", 0 ],
			"obj-27" : [ "live.text[1]", "live.text", 0 ],
			"obj-16" : [ "gain", "gain", 0 ],
			"obj-18" : [ "Dry/Wet", "Dry/Wet", 0 ],
			"obj-13" : [ "Bitdepth", "Bitdepth", 0 ],
