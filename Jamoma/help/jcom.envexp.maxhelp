{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 385.0, 62.0, 909.0, 665.0 ],
		"bglocked" : 0,
		"defrect" : [ 385.0, 62.0, 909.0, 665.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "@name", "jcom.envexp", "@description", "Envelope with linear rise and exponential decay." ],
					"bgmode" : 1,
					"id" : "obj-46",
					"maxclass" : "bpatcher",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 909.0, 70.0 ],
					"varname" : "maxhelpui"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 764.0, 437.0, 76.0, 19.0 ],
					"text" : "sprintf get%s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 765.0, 416.0, 100.0, 19.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 621.0, 416.0, 44.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 448.0, 416.0, 47.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 383.0, 416.0, 52.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 316.0, 494.0, 75.0, 19.0 ],
					"text" : "print dump"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 31.0, 188.0, 32.5, 17.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 31.0, 169.0, 56.0, 19.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"patching_rect" : [ 31.0, 217.0, 159.0, 19.0 ],
									"types" : [  ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 30.0, 240.0, 65.0, 17.0 ],
									"preset_data" : [ 										{
											"number" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 190.0, 245.0, 21.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 235.0, 245.0, 60.0, 19.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 30.0, 265.0, 44.0, 19.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 190.0, 275.0, 63.0, 19.0 ],
									"text" : "metro 500"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 190.0, 350.0, 34.0, 19.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 440.0, 390.0, 32.5, 17.0 ],
									"text" : "stop"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 365.0, 390.0, 72.0, 17.0 ],
									"text" : "startwindow"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 190.0, 440.0, 34.0, 19.0 ],
									"text" : "dac~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 390.0, 150.0, 70.0 ],
									"rounded" : 0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 305.0, 365.0, 64.0, 19.0 ],
									"text" : "cycle~ 440"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 190.0, 390.0, 133.0, 19.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 190.0, 325.0, 297.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 110.0, 290.0, 49.0, 17.0 ],
									"text" : "steal $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 29.0, 202.0, 54.0, 31.0 ],
									"text" : "Examples:"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 28.0, 48.0, 450.0, 55.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 28.0, 123.0, 455.0, 55.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 80.0, 270.0, 22.0, 19.0 ],
									"text" : "dB"
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 199.5, 434.0, 214.5, 434.0 ],
									"source" : [ "obj-16", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 374.5, 429.0, 199.5, 429.0 ],
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-13", 0 ],
									"hidden" : 0,
									"midpoints" : [ 449.5, 429.0, 199.5, 429.0 ],
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 39.5, 317.0, 199.5, 317.0 ],
									"source" : [ "obj-18", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-17", 0 ],
									"hidden" : 0,
									"midpoints" : [ 119.5, 314.0, 199.5, 314.0 ],
									"source" : [ "obj-20", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 199.5, 372.0, 39.5, 372.0 ],
									"source" : [ "obj-10", 0 ]
								}
