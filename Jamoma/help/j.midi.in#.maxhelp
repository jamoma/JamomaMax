...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 140.0, 260.0, 123.0, 19.0 ],
									"text" : "pack s i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 140.0, 235.0, 71.0, 19.0 ],
									"text" : "buddy"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 140.0, 210.0, 123.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 140.0, 285.0, 94.0, 19.0 ],
									"text" : "print COOKED"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 340.0, 155.0, 69.0, 19.0 ],
									"text" : "print RAW"
								}
...
,
					"patching_rect" : [ 550.0, 85.0, 131.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-20",
					"items" : [ "USB Axiom 25 Port 1", ",", "to Max 1", ",", "to Max 2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-11",
					"items" : [ "USB Axiom 25 Port 1", ",", "USB Axiom 25 Port 2", ",", "from Max 1", ",", "from Max 2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
