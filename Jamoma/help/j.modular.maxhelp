...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 223.0, 340.0, 305.0, 67.0 ],
					"presentation_rect" : [ 246.0, 350.0, 0.0, 0.0 ],
					"text" : "This external will be revamped in a near future… It will be sleeped in j.osc / j.minuit / j.app etc…",
					"underline" : 1
				}
