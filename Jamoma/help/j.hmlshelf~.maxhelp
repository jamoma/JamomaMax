{
	"patcher" : 	{
		...
		"bglocked" : 0,
		"defrect" : [ 274.0, 44.0, 984.0, 607.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "@name", "j.hmlshelf~", "@description", "High mid low shelf-filter implementation using one biquad filter" ],
					"bgmode" : 1,
					"id" : "obj-3",
					"maxclass" : "bpatcher",
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 392.5, 431.0, 422.5, 431.0 ],
					"source" : [ "obj-26", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 392.5, 355.5, 116.5, 355.5 ],
					"source" : [ "obj-26", 1 ]
				}
