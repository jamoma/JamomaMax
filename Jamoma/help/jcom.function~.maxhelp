...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-16",
					"items" : [ "apply", ",", "generate" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 322.5, 223.0, 100.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 363.0, 250.0, 59.5, 17.0 ],
					"text" : "mode $1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 185.0, 94.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 185.0, 121.0, 33.0, 19.0 ],
					"text" : "sig~"
				}
...
,
					"patching_rect" : [ 338.0, 363.0, 32.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 410.0, 77.0, 19.0 ],
					"text" : "prepend type"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 338.0, 387.0, 127.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 338.0, 338.0, 105.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 185.0, 526.0, 88.0, 19.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jcom.function~", "@description", "FunctionLib for MSP" ],
					"bgmode" : 1,
					"id" : "obj-14",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 185.0, 305.0, 172.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 44.0, 500.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 207.0, 250.0, 75.0, 17.0 ],
					"text" : "getFunctions"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 372.5, 285.5, 194.5, 285.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 401.5, 441.0, 490.0, 441.0, 490.0, 285.0, 194.5, 285.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 216.5, 285.5, 194.5, 285.5 ],
					"source" : [ "obj-5", 0 ]
				}
