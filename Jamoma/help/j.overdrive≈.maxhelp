...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 89.0, 302.5, 130.0, 130.0 ],
					"trigger" : 1,
					"triglevel" : 0.5
				}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "j.overdrive≈", "@description", "Saturate audio signal" ],
					"bgmode" : 1,
					"id" : "obj-18",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 89.0, 275.0, 91.0, 19.0 ],
					"text" : "j.unpack≈ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 89.0, 247.0, 94.0, 19.0 ],
					"text" : "j.overdrive≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 89.0, 80.0, 170.0, 19.0 ],
