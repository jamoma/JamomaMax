...
, 							{
								"box" : 								{
									...
									"cellmap" : [ [ 0, 0, "data" ], [ 0, 1, "data/in.my_model_channel" ], [ 0, 2, "data/out.my_model_channel" ], [ 0, 3, "model" ] ],
									"cols" : 1,
									"colwidth" : 200,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 844.0, 723.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 844.0, 537.666626, 114.0, 23.0 ],
									"style" : "",
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 342.0, 135.0, 271.0, 78.0 ],
													"style" : "",
													"text" : "Argument sets the instance name to register output in the namespace.\n\nj.in and j.out sharing the same name are internally linked so model processing can be bypassed.",
													"textcolor" : [ 0.6, 0.6, 0.6, 1.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 352.0, 249.0, 239.0, 64.0 ],
													"style" : "",
													"text" : "Name of the instance output to manage (<model>/data/out.<argument>)",
													"textcolor" : [ 0.3, 0.3, 0.3, 1.0 ]
												}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 844.0, 616.0, 50.0, 22.0 ],
									"style" : ""
								}
