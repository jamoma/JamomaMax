...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 218.046875, 53.625 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 146.0, 154.0, 47.0, 20.0 ],
									"text" : "sig~ -2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 85.0, 154.0, 43.0, 20.0 ],
									"text" : "sig~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 146.0, 525.0, 56.0, 20.0 ],
									"sig" : 0.0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "float" ],
									"patching_rect" : [ 85.0, 525.0, 56.0, 20.0 ],
									"sig" : 0.0
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 346.0, 282.0, 72.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 252.0, 307.0, 80.0, 18.0 ],
									"text" : "lowBound $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 346.0, 307.0, 85.0, 18.0 ],
									"text" : "highBound $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 252.0, 282.0, 72.0, 20.0 ]
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@description", "limit the range of a signal" ],
									"bgmode" : 1,
									"id" : "obj-56",
									"maxclass" : "bpatcher",
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.clip≈ @lowBound -1 @highBound 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 281.0, 465.0, 43.0, 43.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 355.5, 358.0, 94.5, 358.0 ],
									"source" : [ "obj-16", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 261.5, 358.0, 94.5, 358.0 ],
									"source" : [ "obj-17", 0 ]
								}
