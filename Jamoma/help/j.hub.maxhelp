{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 119.0, 111.0, 1162.0, 681.0 ],
		"bglocked" : 0,
		"defrect" : [ 119.0, 111.0, 1162.0, 681.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@name", "j.hub", "@description", "The central nervous system of a Jamoma module" ],
					"bgmode" : 1,
					"id" : "obj-44",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 890.0, 280.0, 205.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "for video modules, use j.in and j.out"
				}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 70.0, 90.0, 197.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "for audio modules, use j.in~ and j.out~"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "communication with the algorithm uses j.in "
				}
...
, 			{
				"box" : 				{
					...
					"text" : "- Leftmost inlet of module is connected to left inlet of j.hub."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "- Left outlet of j.hub connected to leftmost outlet of module."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 890.0, 470.0, 74.0, 19.0 ],
					"text" : "s incoming"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 890.0, 420.0, 118.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 905.0, 445.0, 211.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "j.message mymessage @type generic"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 550.0, 320.0, 84.0, 24.0 ],
					"text" : "j.hub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 555.0, 385.0, 249.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "For information on configuring the attributes to the j.hub object, please refer to the Jamoma tutorials. These are the best source for getting familiar with the steps involved in building modules."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.hub is the central brain in a jamoma module. It parses input, distributes messaging to parameters, manages the pattrstorage object, generates documentation, configures the j.gui object, etc."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 895.0, 520.0, 52.0, 19.0 ],
					"text" : "See also"
				}
