...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 25.0, 17.0, 661.0, 489.0 ]
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 40.0, 19.0, 411.0, 363.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 60.0, 393.0, 238.0, 21.0 ],
									"text" : "j.receive /template_help/this_parameter"
								}

							}
, 							{
								"box" : 								{
									"annotation" : "This module doesn't do much yet",
									"args" : [ "/template_help" ],
									"id" : "obj-2",
									"maxclass" : "bpatcher",
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 60.0, 268.0, 300.0, 70.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 60.0, 166.0, 50.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 60.0, 192.0, 203.0, 19.0 ],
									"text" : "j.send /template_help/this_parameter"
								}
