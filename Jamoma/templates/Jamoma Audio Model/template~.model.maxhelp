...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 376.0, 371.0, 35.0, 20.0 ],
					"text" : "j.init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 398.0, 59.0, 18.0 ],
					"text" : "jamoma"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 426.0, 133.0, 33.0 ],
					"text" : "j.send filter~(view)/ui:highlight"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.21875, 54.0, 177.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.0, 422.0, 137.0, 18.0 ],
					"text" : "/template~_help"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 202.0, 156.0, 156.0, 33.0 ],
									"text" : "don't forget to name these models..."
								}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 56.5, 415.5, 174.5, 415.5 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				...
				"bootpath" : "/Users/WALL-E/Documents/Jamoma/Implementations/Max/Jamoma/patchers/components/_deprecated/fileLoader",
