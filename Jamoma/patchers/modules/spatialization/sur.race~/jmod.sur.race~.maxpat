...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 275.0, 92.0, 128.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 149.0, 3.0, 95.0, 14.0 ],
					"range" : [ -10.0, 3.0 ],
					"text" : "sidechain",
					"textpos" : [ 10.0, 2.0 ],
					"unit" : "dB"
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 78.0, 269.0, 80.0, 19.0 ],
					"text" : "jalg.sur.race~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 321.0, 166.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 263.0, 46.0, 36.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 196.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 321.0, 193.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 81.0, 24.0, 50.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 322.0, 221.0, 50.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 135.0, 139.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 308.0, 285.0, 131.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 148.0, 23.0, 111.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 308.0, 310.0, 135.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 148.0, 46.0, 112.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 135.0, 34.0, 17.0 ],
					"text" : "/init"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 308.0, 336.0, 67.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 22.0, 67.0, 19.0 ],
					"text" : "delay [µs]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 308.0, 360.0, 98.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 45.0, 98.0, 19.0 ],
					"text" : "attenuation [dB]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 117.0, 196.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.0, 350.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 78.0, 350.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.0, 196.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 321.0, 140.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 263.0, 23.0, 36.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 69.5, 157.0, 34.5, 157.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 214.5, 160.0, 34.5, 160.0 ],
					"source" : [ "obj-25", 0 ]
				}
