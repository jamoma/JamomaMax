{
  "patcher": {
    ...
    "boxes": [
      ...
      {
        "box": {
          "annotation": "switch blockwise interpolation of all coefficient changes on/off",
          "bgcolor": [
            1.0,
            1.0,
            1.0,
      ...
      },
      {
        "box": {
          ...
          "text": "j.model @description \"ICST Ambipanning for multiple sources for multiple speakers.\"",
          "varname": "j.model"
        }
      },
      {
    ...
    "dependency_cache": [
      {
        "name": "jalg.sur.ambipanning~.maxpat",
