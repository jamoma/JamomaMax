{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 24.0, 382.0, 1243.0, 528.0 ],
		"bglocked" : 0,
		"defrect" : [ 24.0, 382.0, 1243.0, 528.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 245.0, 136.0, 196.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 544.0, 59.0, 41.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 544.0, 149.0, 40.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"hidden" : 0,
					"midpoints" : [ 553.5, 118.0, 537.0, 118.0, 537.0, 53.0, 553.5, 53.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 553.5, 208.0, 537.0, 208.0, 537.0, 145.0, 553.5, 145.0 ],
					"source" : [ "obj-22", 0 ]
				}
