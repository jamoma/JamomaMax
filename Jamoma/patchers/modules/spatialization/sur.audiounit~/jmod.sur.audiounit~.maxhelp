{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 669.0, 152.0, 662.0, 726.0 ],
		"bglocked" : 0,
		"defrect" : [ 669.0, 152.0, 662.0, 726.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 569.0, 300.0, 70.0 ],
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 242.0, 268.0, 81.0, 20.0 ],
									"text" : "loadmess set"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 413.0, 296.0, 169.0, 19.0 ],
									"text" : "3) watch the attributes"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 139.0, 117.0, 173.0, 19.0 ],
									"text" : "1) press here "
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 66.0, 117.0, 70.0, 18.0 ],
									"text" : "/audiounit~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "set" ],
									"patching_rect" : [ 151.0, 191.0, 42.0, 19.0 ],
									"text" : "t s set"
								}
									...
									"patcher" : 									{
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 160.0, 198.0, 91.0, 20.0 ],
													"text" : "loadmess clear"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 51.0, 192.0, 92.0, 19.0 ],
													"text" : "prepend append"
												}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 266.0, 166.0, 169.0, 19.0 ],
									"text" : "2) Select parameter"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"patching_rect" : [ 66.0, 166.0, 190.0, 19.0 ],
									"types" : [  ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 160.5, 216.0, 75.5, 216.0 ],
									"source" : [ "obj-38", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-29", 0 ],
									"hidden" : 0,
									"midpoints" : [ 183.5, 285.0, 75.5, 285.0 ],
									"source" : [ "obj-38", 1 ]
								}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.sur.audiounit~", "@description", "Multichannel AudioUnit plug-ins wrapper" ],
					"bgmode" : 1,
					"id" : "obj-6",
					"maxclass" : "bpatcher",
...
,
					"patching_rect" : [ 23.0, 279.0, 57.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontname" : "Verdana",
						"fontname" : "Verdana",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 760.0, 81.0, 400.0, 366.0 ],
						"bglocked" : 0,
						"defrect" : [ 760.0, 81.0, 400.0, 366.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "Bring up /audio/gain/ to appropriate level."
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Update separate AU if so desired."
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Load new plug-in using the /au/plug message."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 16.0, 29.0, 271.0, 28.0 ],
									"text" : "Using jmod.sur.audiounit~:"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 75.0, 365.0, 31.0 ],
									"text" : "jmod.sur.audiounit~ creates a dynamic OSC namespace reflecting the parameters of the AU plug-in currently loaded."
								}
...
, 							{
								"box" : 								{
									...
									"text" : "When using mod.sur.audiounit~ with jmod.cueScript or jmod.cuemanager it is recommended to introduce a new AU plug-in thrugh a series of steps in a certain order, with a bit of time left in between for Max and Jamoma to catch up:"
								}
...
,
					"patching_rect" : [ 366.0, 415.0, 224.0, 24.0 ],
					"saved_object_attributes" : 					{
						"default_fontname" : "Verdana",
						"fontname" : "Verdana",
						"default_fontsize" : 10.0,
...
,
					"text" : "p \"Using jmod.sur.audiounit~\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 538.0, 251.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 115.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 179.44606, 273.0, 31.0 ],
					"text" : "jmod.sur.audiounit~ creates a dynamic namespace depending on the parameters of the plug-in loaded."
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"hidden" : 0,
					"midpoints" : [ 32.5, 531.0, 287.5, 531.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 173.5, 296.0, 313.5, 296.0 ],
					"source" : [ "obj-7", 0 ]
				}
