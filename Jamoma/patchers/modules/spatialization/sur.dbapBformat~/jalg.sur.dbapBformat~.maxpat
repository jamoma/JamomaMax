{
	"patcher" : 	{
		...
		"bglocked" : 0,
		"defrect" : [ 40.0, 113.0, 1119.0, 546.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patcher" : 					{
						...
						"bglocked" : 0,
						"defrect" : [ 35.0, 86.0, 1187.0, 624.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.oscroute /numSources /numSpeakers /audio"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.pass /info /dimensions /rolloff"
								}
...
,
					"patching_rect" : [ 85.0, 145.0, 70.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 10.0,
						"globalpatchername" : "",
