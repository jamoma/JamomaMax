...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 232.0, 225.0, 68.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 202.0, 45.5, 41.0, 19.0 ],
					"text" : "Rolloff"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 232.0, 135.0, 68.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 175.0, 25.5, 68.0, 19.0 ],
					"text" : "Dimensions"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 315.0, 225.0, 40.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 243.0, 45.5, 40.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 315.0, 135.0, 40.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 243.0, 25.5, 40.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 315.0, 360.0, 40.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 118.0, 45.5, 40.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 315.0, 435.0, 40.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 118.0, 25.5, 40.0, 19.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 324.5, 246.0, 300.0, 246.0, 300.0, 192.0, 324.5, 192.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 324.5, 456.0, 300.0, 456.0, 300.0, 402.0, 324.5, 402.0 ],
					"source" : [ "obj-9", 0 ]
				}
