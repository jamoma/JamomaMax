...
,
					"patching_rect" : [ 742.0, 46.0, 108.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 903.0, 284.0, 176.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 742.0, 223.0, 37.0, 20.0 ],
					"text" : "== 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 742.0, 275.5, 53.0, 18.0 ],
					"text" : "mute $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 903.0, 398.0, 80.0, 18.0 ],
					"text" : "linearGain $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 715.0, 300.0, 46.0, 20.0 ],
					"text" : "gate 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 876.0, 426.0, 46.0, 20.0 ],
					"text" : "gate 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 569.0, 223.0, 46.0, 20.0 ],
					"text" : "gate 3"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameterArray aux.[3]/gain @repetitions/filter 1 @type decimal @range/bounds -70. 12. @range/clipmode both @ramp/drive Max @dataspace gain @dataspace/unit db @format single @description \"Gain of the input cable applied to the auxiliary bus.\"",
					"varname" : "aux.1/gain"
				}
