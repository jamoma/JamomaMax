...
,
		"rect" : [ 62.0, 44.0, 639.0, 703.0 ],
		"bglocked" : 0,
		"defrect" : [ 62.0, 44.0, 639.0, 703.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 221.0, 281.0, 91.0, 19.0 ],
					"text" : "double click -->"
				}
...
,
						"rect" : [ 325.0, 206.0, 640.0, 480.0 ],
						"bglocked" : 0,
						"defrect" : [ 325.0, 206.0, 640.0, 480.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 444.0, 194.0, 184.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 360.5, 225.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 362.0, 166.0, 275.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 245.0, 124.0, 35.0, 17.0 ],
									"text" : "clear"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 142.5, 201.0, 25.0, 25.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"hidden" : 0,
									"midpoints" : [ 152.0, 69.0, 371.5, 69.0 ],
									"source" : [ "obj-44", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 152.0, 82.0, 254.5, 82.0 ],
									"source" : [ "obj-44", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 152.0, 84.0, 59.5, 84.0 ],
									"source" : [ "obj-44", 0 ]
								}
...
,
						"rect" : [ 409.0, 133.0, 344.0, 503.0 ],
						"bglocked" : 0,
						"defrect" : [ 409.0, 133.0, 344.0, 503.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 14.0, 228.0, 80.0, 17.0 ],
									"text" : "/type speaker"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 501.5, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 62.0, 327.5, 52.0, 17.0 ],
									"text" : "/order 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 40.0, 113.5, 215.0, 19.0 ],
									"text" : "j.initialized /sur.ambi.decode~ 2000"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 60.0, 507.5, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 179.0, 247.5, 59.5, 19.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 12.0,
						"default_fontname" : "Arial",
...
,
					"patching_rect" : [ 18.0, 125.5, 24.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 12.0,
						"default_fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 92.0, 242.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 173.0, 90.0, 19.0 ],
					"text" : "loadmess set 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.0, 201.0, 135.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 205.0, 196.0, 47.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 221.0, 67.0, 17.0 ],
					"text" : "/gain/W $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 306.0, 559.0, 189.0, 19.0 ],
					"text" : "substitute /channels /numSpeakers"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 306.0, 583.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 306.0, 415.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "audio.connect" ],
					"patching_rect" : [ 306.0, 317.0, 300.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-6",
					"maxclass" : "bpatcher",
					"name" : "jmod.sur.zoomH2ambi~.maxpat",
					"numinlets" : 6,
					"numoutlets" : 2,
					"outlettype" : [ "", "audio.connect" ],
					"patching_rect" : [ 306.0, 196.0, 300.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "audio.connect" ],
					"patching_rect" : [ 305.0, 280.0, 301.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "audio.connect" ],
					"patching_rect" : [ 306.0, 117.0, 300.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.sur.zoomH2ambi~", "@description", "Convert a Zoom-H2 four channel recording into a horizontal-only B-format 2nd order" ],
					"bgmode" : 1,
					"id" : "obj-19",
					"maxclass" : "bpatcher",
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"hidden" : 0,
					"midpoints" : [ 214.5, 242.0, 295.0, 242.0, 295.0, 192.0, 315.5, 192.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 143.5, 428.0, 295.5, 428.0, 295.5, 312.0, 315.5, 312.0 ],
					"source" : [ "obj-46", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 1 ],
					"hidden" : 0,
					"midpoints" : [ 596.5, 308.5, 596.5, 308.5 ],
					"source" : [ "obj-5", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"hidden" : 0,
					"midpoints" : [ 596.5, 275.0, 596.5, 275.0 ],
					"source" : [ "obj-6", 1 ]
				}
