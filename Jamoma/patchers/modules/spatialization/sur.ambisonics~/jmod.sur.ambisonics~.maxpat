...
, 			{
				"box" : 				{
					...
					"text" : "j.message report @repetitions/allow 1 @type none @description \"reports the state of the ambisonics external in the max window\""
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter order @repetitions/allow 0 @type integer @range/bounds 1 11 @range/clipmode both @description \"Ambisonics order of decoding and encoding\"",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 291.0, 182.0, 150.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 13.0, 127.825241, 66.0, 20.0 ],
									"text" : "Amplitude"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 276.0, 167.0, 150.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 74.0, 156.0, 100.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 578.0, 108.0, 150.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 515.0, 156.0, 93.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 561.0, 130.0, 46.0, 20.0 ],
									"text" : "sel 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 560.0, 109.0, 18.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 497.0, 156.0, 18.0, 18.0 ],
									"size" : 1,
									"values" : [ 0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 640.0, 103.0, 175.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 628.0, 123.0, 188.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 626.0, 144.0, 69.0, 20.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 52.0, 239.0, 81.0, 20.0 ],
													"text" : "prepend tabs"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 93.0, 288.0, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 88.0, 202.0, 53.0, 20.0 ],
													"text" : "zl group"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "bang", "bang", "int" ],
													"patching_rect" : [ 81.0, 139.0, 46.0, 20.0 ],
													"text" : "uzi 8 1"
												}
...
,
									"patching_rect" : [ 96.0, 19.0, 69.0, 20.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 96.0, 42.0, 88.0, 19.0 ],
									"presentation" : 1,
									"presentation_rect" : [ -1.0, -1.0, 615.0, 19.0 ],
									"rounded" : 1.0,
									"tabs" : [ "1", "2", "3" ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 359.0, 29.0, 32.5, 20.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 6.0, 15.0, 51.0, 20.0 ],
									"text" : "source  "
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 166.0, 72.0, 50.0, 20.0 ],
									"triangle" : 0
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 427.0, 116.0, 587.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 428.0, 82.0, 605.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter interpolation @repetitions/allow 0 @type boolean @range/bounds 0 1 @range/clipmode both @description \"switch on/off blockwise interpolation of all coefficient changes in the encoding stage.\"",
