	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.0, 348.0, 46.0, 17.0 ],
					"text" : "/report"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 325.0, 369.0, 279.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 48.0, 568.0, 160.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 492.0, 225.0, 17.0 ],
					"text" : "/view/panel"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 608.0, 293.0, 74.0, 19.0 ],
					"text" : "Default: 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 586.0, 268.0, 87.0, 19.0 ],
					"text" : "loadmess set 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 586.0, 318.0, 115.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.0, 294.0, 74.0, 19.0 ],
					"text" : "Default: 1"
				}
...
,
					"patching_rect" : [ 306.0, 487.0, 220.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontsize" : 12.0,
						"default_fontface" : 0,
						"default_fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.0, 268.0, 87.0, 19.0 ],
					"text" : "loadmess set 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 227.0, 218.0, 55.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 25.0, 369.0, 300.0, "fontsize": 12.05.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 34.5, 485.0, 247.5, 485.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"hidden" : 0,
					"midpoints" : [ 175.0, 480.0, 263.0, 480.0, 263.0, 528.0, 198.5, 528.0 ],
					"source" : [ "obj-22", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 315.5, 479.5, 315.5, 479.5 ],
					"source" : [ "obj-22", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"hidden" : 0,
					"midpoints" : [ 414.0, 340.0, 34.5, 340.0 ],
					"source" : [ "obj-27", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"hidden" : 0,
					"midpoints" : [ 595.5, 340.0, 34.5, 340.0 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"hidden" : 0,
					"midpoints" : [ 236.5, 260.0, 236.0, 260.0, 236.0, 340.0, 34.5, 340.0 ],
					"source" : [ "obj-4", 0 ]
				}
