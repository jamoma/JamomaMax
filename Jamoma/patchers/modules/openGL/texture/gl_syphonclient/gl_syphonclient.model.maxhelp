...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 18.5, 124.0, 81.0, 19.0 ],
									"text" : "jit.window foo"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 141.5, 124.0, 150.0, 31.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 18.5, 20.0, 119.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 141.5, 48.0, 126.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 141.5, 83.0, 137.0, 31.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 18.5, 48.0, 124.5, 19.0 ],
									"text" : "t erase b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 18.5, 83.0, 87.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 141.5, 20.0, 156.0, 21.0 ],
									"text" : "j.initialized syphonclient"
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 151.0, 73.5, 151.0, 73.5 ],
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 133.5, 74.5, 151.0, 74.5 ],
									"source" : [ "obj-7", 2 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 80.75, 79.0, 28.0, 79.0 ],
									"source" : [ "obj-7", 1 ]
								}
...
,
					"patching_rect" : [ 20.5, 340.0, 66.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 349.0, 70.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "gl.syphonclient.view.maxpat",
				"bootpath" : "/Users/reno/Documents/GITs/Jamoma/Implementations/Max/Jamoma/patchers/modules/opentexture/gl.syphonclient",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "gl.videoplane.view.maxpat",
				"bootpath" : "/Users/reno/Documents/GITs/Jamoma/Implementations/Max/Jamoma/patchers/modules/opengeometry /gl.videoplane",
...
, 			{
				...
				"bootpath" : "/Users/reno/Documents/GITs/Jamoma/Implementations/Max/Jamoma/patchers/components/opengl_group",
				"patcherrelativepath" : "../../../../components/opengl_group",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
