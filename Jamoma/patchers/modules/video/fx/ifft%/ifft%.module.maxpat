...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 166.0, 171.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					"annotation" : "Inverse FFT processing of incoming matrix.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-4",
					"maxclass" : "newobj",
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 7.0, 146.0, 178.0, 19.0 ],
					"text" : "ifft%.model #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.0, 116.0, 25.0, 25.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/reno/Documents/GITs/Jamoma/Implementations/Max/Jamoma/patchers/modules/video/ifft%",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
