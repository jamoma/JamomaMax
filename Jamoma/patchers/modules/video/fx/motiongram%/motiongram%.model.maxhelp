...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.0, 387.0, 55.0, 19.0 ],
					"text" : "r module"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 587.0, 132.0, 55.0, 19.0 ],
					"text" : "r module"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 154.0, 49.0, 17.0 ],
									"text" : "line $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 50.0, 127.0, 50.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 178.0, 154.0, 49.0, 17.0 ],
									"text" : "line $1"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 289.0, 132.0, 32.5, 17.0 ],
													"text" : "$3"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 391.0, 168.0, 32.5, 17.0 ],
													"text" : "$2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "int", "int" ],
													"patching_rect" : [ 50.0, 189.0, 77.0, 19.0 ],
													"text" : "unpack 0 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 290.0, 309.0, 97.0, 19.0 ],
													"text" : "expr $i1*$i2/240"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 290.0, 339.5, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 50.0, 259.0, 50.0, 19.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 402.0, 307.0, 97.0, 19.0 ],
													"text" : "expr $i1*$i2/320"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 110.0, 259.0, 50.0, 19.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 50.0, 140.0, 59.0, 19.0 ],
													"text" : "route dim"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 111.0, 76.0, 19.0 ],
													"text" : "jit.matrixinfo"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 403.0, 332.5, 25.0, 25.0 ]
												}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 178.0, 127.0, 50.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 178.0, 231.0, 25.0, 25.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 432.0, 68.0, 17.0 ],
					"text" : "direction 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 621.0, 481.0, 251.0, 177.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 587.0, 168.0, 300.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 244.0, 54.0, 19.0 ],
					"text" : "s module"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 531.0, 327.0, 531.0, 327.0, 450.0, 348.5, 450.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 165.0, 537.0, 336.0, 537.0, 336.0, 477.0, 348.5, 477.0 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 631.5, 475.0, 651.0, 475.0, 651.0, 475.0, 894.0, 475.0, 894.0, 165.0, 877.5, 165.0 ],
					"source" : [ "obj-20", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 589.5, 471.0, 590.0, 471.0, 590.0, 675.0, 315.0, 675.0, 315.0, 450.0, 305.5, 450.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 569.5, 448.5, 631.5, 448.5 ],
					"source" : [ "obj-27", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 348.5, 446.5, 589.5, 446.5 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 280.5, 249.0, 579.0, 249.0, 579.0, 165.0, 596.5, 165.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 280.5, 449.0, 24.5, 449.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 280.5, 249.5, 348.5, 249.5 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "motion2%.module.maxpat",
				"bootpath" : "/Users/bltzr/dev/Jamoma/Implementations/Max/Jamoma/patchers/modules/video/motion2%",
...
, 			{
				"name" : "motiongram%.module.maxpat",
				"bootpath" : "/Users/bltzr/dev/Jamoma/Implementations/Max/Jamoma/patchers/modules/video/motiongram%",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
