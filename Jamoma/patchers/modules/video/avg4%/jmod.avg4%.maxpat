{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 233.0, 44.0, 845.0, 582.0 ],
		"bglocked" : 0,
		"defrect" : [ 233.0, 44.0, 845.0, 582.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 236.0, 23.0, 60.0, 45.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 241.0, 117.0, 32.5, 17.0 ],
					"text" : "/init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 97.0, 196.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 196.0, 34.0, 34.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 386.0, 64.0, 22.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 180.0, 34.0, 22.0, 19.0 ],
					"text" : "y"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 385.0, 30.0, 22.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 123.0, 34.0, 22.0, 19.0 ],
					"text" : "x"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 416.0, 108.0, 45.0, 19.0 ],
					"pattrmode" : 1,
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 379.0, 114.0, 48.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 14.0, 34.0, 48.0, 19.0 ],
					"text" : "mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.0, 117.0, 137.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 382.0, 86.0, 19.0 ],
					"text" : "VIDEO OUTPUT"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.0, 265.0, 13.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 265.0, 76.0, 19.0 ],
					"text" : "VIDEO INPUT"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 115.0, 87.0, 19.0 ],
					"text" : "command input"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 143.0, 332.0, 98.0, 19.0 ],
					"text" : "jalg.avg4%"
				}
