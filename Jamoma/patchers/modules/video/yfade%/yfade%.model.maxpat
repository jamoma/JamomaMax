...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 622.0, 305.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter yfade @type decimal @ramp/drive Max @repetitions/filter 1 @range/bounds 0. 1. @range/clipmode both @description \"Crossfade switch\"",
					"varname" : "yfade"
				}
