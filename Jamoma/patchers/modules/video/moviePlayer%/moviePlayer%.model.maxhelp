...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "@name", "moviePlayer%.model", "@description", "Playback of Quicktime movies" ],
					"bgmode" : 1,
					"id" : "obj-5",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 619.0, 541.0, 79.0, 17.0 ],
					"text" : "input%.model"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 616.5, 276.5, 335.5, 276.5 ],
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "moviePlayer%.module.maxpat",
				"bootpath" : "/Users/WALL-E/Documents/Jamoma/Implementations/Max/Jamoma/patchers/modules/video/moviePlayer%",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
