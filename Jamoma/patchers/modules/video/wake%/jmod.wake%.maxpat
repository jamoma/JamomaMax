{
	"patcher" : 	{
		...
		"bglocked" : 0,
		"defrect" : [ 235.0, 79.0, 750.0, 484.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 428.0, 221.0, 111.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 303.0, 222.0, 111.0, 19.0 ],
									"text" : "scale -200 200 0. 1."
								}
...
,
					"patching_rect" : [ 357.0, 44.0, 79.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.0, 303.0, 77.0, 19.0 ],
					"text" : "VIDEO INPUT",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 122.0, 137.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.0, 20.0, 36.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 161.0, 21.0, 36.0, 19.0 ],
					"text" : "bleed"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 34.0, 30.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 166.0, 42.0, 30.0, 19.0 ],
					"text" : "gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 362.0, 367.0, 79.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 396.0, 154.0, 35.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 416.0, 77.0, 35.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 357.0, 289.0, 35.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 20.0, 69.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 59.094215, 21.0, 69.0, 19.0 ],
					"text" : "feedforward"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 377.0, 222.0, 35.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 34.0, 54.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 74.094215, 43.0, 54.0, 19.0 ],
					"text" : "feedback"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.0, 422.0, 87.0, 19.0 ],
					"text" : "VIDEO OUTPUT",
					"textcolor" : [ 0.003922, 0.003922, 0.003922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 419.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 51.0, 122.0, 88.0, 19.0 ],
					"text" : "command input",
					"textcolor" : [ 0.003922, 0.003922, 0.003922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 85.0, 372.0, 131.0, 19.0 ],
					"text" : "jalg.wake%"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 371.5, 419.0, 356.0, 419.0, 356.0, 362.0, 371.5, 362.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"hidden" : 0,
					"midpoints" : [ 405.5, 208.0, 394.0, 208.0, 394.0, 151.0, 405.5, 151.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 425.5, 133.0, 412.0, 133.0, 412.0, 73.0, 425.5, 73.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 386.5, 276.0, 372.0, 276.0, 372.0, 219.0, 386.5, 219.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"hidden" : 0,
					"midpoints" : [ 366.5, 343.0, 351.0, 343.0, 351.0, 286.0, 366.5, 286.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 0 ],
					"hidden" : 0,
					"midpoints" : [ 149.5, 156.0, 27.5, 156.0 ],
					"source" : [ "obj-7", 0 ]
				}
