...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 39.0, 357.0, 255.0, 18.0 ],
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 48.5, 352.5, 284.5, 352.5 ],
									"source" : [ "obj-2", 0 ]
								}
...
,
		...
		"dependency_cache" : [ 			{
				"name" : "10harmonics~.module.maxpat",
				"bootpath" : "/Users/WALL-E/Documents/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/10harmonics~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
