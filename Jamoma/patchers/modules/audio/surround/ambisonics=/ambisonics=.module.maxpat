...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 201.5, 320.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 198.0, 216.0, 25.0, 25.0 ],
					"presentation_rect" : [ 201.5, 216.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 142.5, 320.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 142.5, 216.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 87.0, 261.0, 130.0, 20.0 ],
					"text" : "ambisonics=.model #1"
				}

			}
, 			{
				"box" : 				{
					"annotation" : "ICST Ambisonics module, complete decoding and encoding  for multiple sources for multiple speakers in one module.",
					"args" : [ "#1" ],
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					"name" : "ambisonics=.view.maxpat",
					"numinlets" : 3,
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "ambisonics=.view.maxpat",
				"bootpath" : "/Users/jln/@Jamoma/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/surround/ambisonics=",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
