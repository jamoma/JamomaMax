...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 912.0, 158.0, 25.0, 25.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 51.0, 152.0, 49.0, 19.0 ],
									"text" : "zl join"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 51.0, 230.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 709.0, 99.0, 69.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 357.0, 97.0, 70.0, 19.0 ],
									"text" : "prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 262.0, 97.0, 70.0, 19.0 ],
									"text" : "prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 124.0, 306.0, 45.0, 19.0 ],
									"text" : "append"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 124.0, 243.0, 45.0, 19.0 ],
									"text" : "append"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 474.0, 346.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 708.0, 47.0, 83.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 220.0, 601.0, 437.5, 20.0 ],
					"text" : "j.pack= 32",
					"varname" : "multiin"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 220.0, 95.0, 451.0, 20.0 ],
					"text" : "j.unpack= 32",
					"varname" : "multiout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1114.0, 93.0, 102.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1114.0, 74.0, 61.0, 20.0 ],
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 708.0, 77.0, 392.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 220.0, 626.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 761.0, 153.0, 75.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 72.0, 172.0, 46.0, 20.0 ],
					"text" : "j.in"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1123.5, 127.0, 770.5, 127.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 145.5, 39.0, 717.5, 39.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1028.333374, 127.0, 770.5, 127.0 ],
					"source" : [ "obj-8", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 966.166687, 125.5, 770.5, 125.5 ],
					"source" : [ "obj-8", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 904.0, 125.223145, 770.5, 125.223145 ],
					"source" : [ "obj-8", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 841.833313, 122.0, 770.5, 122.0 ],
					"source" : [ "obj-8", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 779.666687, 121.5, 770.5, 121.5 ],
					"source" : [ "obj-8", 1 ]
				}
