...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 87.0, 261.0, 100.0, 20.0 ],
					"text" : "setup=.model #1"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Describe position of instances as sets of xyz coordinates.",
					"args" : [ "#1" ],
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					"name" : "setup=.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "setup=.view.maxpat",
				"bootpath" : "/Users/jln/@Jamoma/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/surround/setup=",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
