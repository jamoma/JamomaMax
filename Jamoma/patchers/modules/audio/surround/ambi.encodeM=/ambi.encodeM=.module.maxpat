...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 87.0, 261.0, 149.0, 20.0 ],
					"text" : "ambi.encodeM=.model #1"
				}

			}
, 			{
				"box" : 				{
					"annotation" : "Ambisonic encoding of mono signals.",
					"args" : [ "#1" ],
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					"name" : "ambi.encodeM=.view.maxpat",
					"numinlets" : 2,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "ambi.encodeM=.view.maxpat",
				"bootpath" : "/Users/jln/@Jamoma/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/surround/ambi.encodeM=",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "ambi.encodeM=.model.maxpat",
				"bootpath" : "/Users/jln/@Jamoma/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/surround/ambi.encodeM=",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
