...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"comment" : "Auxiliary multichannel signal 3",
					"id" : "obj-8",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.333328, 320.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 122.666664, 320.0, 25.0, 25.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "aux=.view.maxpat",
				"bootpath" : "/Users/nilspeters/Documents/gits/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/surround/aux=",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
