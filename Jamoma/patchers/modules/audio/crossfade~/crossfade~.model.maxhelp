...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 33.0, 663.0, 141.0, 20.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 129.0, 389.0, 87.0, 21.0 ],
									"text" : "loadmess set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 140.0, 268.0, 139.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 129.0, 437.0, 137.0, 18.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 91.5, 58.0, 58.0, 20.0 ],
													"text" : "loadbang"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 91.5, 100.0, 155.0, 18.0 ],
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 91.5, 128.0, 159.5, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 91.5, 208.0, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 161.5, 208.0, 25.0, 25.0 ]
												}
...
,
									"patching_rect" : [ 433.75, 268.0, 89.25, 20.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 12.0,
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 91.5, 54.0, 58.0, 20.0 ],
													"text" : "loadbang"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 91.5, 100.0, 157.0, 18.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "signal", "signal", "bang" ],
													"patching_rect" : [ 91.5, 128.0, 150.0, 20.0 ],
													"save" : [ "#N", "sfplay~", "", 2, 120960, 0, "", ";" ],
													"text" : "sfplay~ 2"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 156.5, 208.0, 25.0, 25.0 ]
												}
...
,
									"patching_rect" : [ 293.25, 268.0, 89.25, 20.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 363.5, 463.0, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "signal", "signal" ],
									"patching_rect" : [ 223.0, 334.0, 300.0, 70.0 ],
...
,
		...
		"dependency_cache" : [ 			{
				"name" : "crossfade~.module.maxpat",
				"bootpath" : "/Users/lossius/dev/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/crossfade~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
