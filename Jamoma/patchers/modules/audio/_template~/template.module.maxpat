...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 658.0, 429.0, 100.0, 12.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 117.0, 10.0, 100.0, 4.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 658.0, 366.0, 100.0, 12.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 117.0, 5.0, 100.0, 4.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 146.0, 384.0, 343.0, 47.0 ],
...
,
					"patching_rect" : [ 658.0, 23.0, 217.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 581.0, 176.0, 44.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 213.0, 23.0, 44.0, 20.0 ],
					"triangle" : 0
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 77.821503, 144.313141, 47.0, 20.0 ],
									"text" : "t 1 b 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 77.821503, 171.313141, 55.0, 20.0 ],
									"text" : "gate 1 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 174.0, 59.0, 248.0, 20.0 ],
									"text" : "additional variables can be declared here"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 36.0, 18.0, 304.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 127.578354, 222.32814, 113.0, 31.0 ],
									"presentation" : 1,
									"presentation_linecount" : 2,
									"presentation_rect" : [ 120.961182, 24.758301, 113.0, 31.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 245.512863, 222.32814, 205.0, 45.0 ],
									"presentation" : 1,
									"presentation_linecount" : 2,
									"presentation_rect" : [ 119.825417, 64.780228, 297.0, 31.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "front" ],
													"patching_rect" : [ 50.0, 94.0, 39.0, 20.0 ],
													"text" : "t front"
												}
...
,
									"patching_rect" : [ 40.0, 232.32814, 43.0, 20.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 40.0, 202.0, 25.0, 25.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 1,
									"midpoints" : [ 137.078354, 271.0, 49.5, 271.0 ],
									"source" : [ "obj-26", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 1,
									"midpoints" : [ 255.012863, 277.811401, 49.5, 277.811401 ],
									"source" : [ "obj-27", 0 ]
								}
...
,
					"patching_rect" : [ 283.0, 85.0, 50.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 72.0, 46.0, 94.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 607.0, 237.0, 18.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 215.0, 46.0, 18.0, 18.0 ],
					"size" : 1,
					"values" : [ 1 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 91.5, 282.0, 81.0, 19.0 ],
					"text" : "signal outputs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 91.5, 114.0, 74.0, 19.0 ],
					"text" : "signal inputs"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 20.0, 21.0, 294.0, 33.0 ],
...
,
					"patching_rect" : [ 658.0, 53.0, 113.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 516.0, 176.0, 59.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 150.0, 23.0, 70.0, 20.0 ],
					"text" : "Message"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 581.0, 136.0, 43.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 72.0, 22.0, 38.0, 20.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "ParameterA"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 516.0, 136.0, 67.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 22.0, 68.0, 20.0 ],
					"text" : "Parameter"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 114.0, 89.0, 19.0 ],
					"text" : "command input"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 91.5, 151.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 91.5, 250.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 169.0, 151.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 14.0, 202.0, 174.0, 20.0 ],
					"text" : "template.model #1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 169.0, 250.0, 25.0, 25.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/lossius/dev/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/_template~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
