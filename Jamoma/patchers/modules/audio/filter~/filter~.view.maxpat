...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 49.166668, 460.0, 110.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 533.0, 423.0, 43.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 533.0, 234.0, 43.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 533.0, 333.0, 120.0, 47.0 ],
					"text" : "j.remote gain @dataspace gain @dataspace/unit db",
					"varname" : "filtergain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 533.0, 258.0, 64.0, 20.0 ],
					"text" : "j.remote q",
					"varname" : "q"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 533.0, 446.0, 110.0, 20.0 ],
					"text" : "j.remote frequency",
					"varname" : "cf"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 533.0, 310.0, 43.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 534.0, 213.0, 506.5, 213.0, 506.5, 133.0, 534.0, 133.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 576.166687, 389.0, 519.0, 389.0, 519.0, 306.0, 542.5, 306.0 ],
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 542.5, 282.0, 519.0, 282.0, 519.0, 231.0, 542.5, 231.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 542.5, 470.0, 525.0, 470.0, 525.0, 420.0, 542.5, 420.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 89.0, 489.0, 284.964294, 489.0, 284.964294, 232.0, 170.928574, 232.0 ],
					"source" : [ "obj-3", 1 ]
				}
