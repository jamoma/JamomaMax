...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 72.0, 469.0, 173.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 72.0, 295.0, 300.0, 140.0 ],
...
,
		...
		"dependency_cache" : [ 			{
				"name" : "filePlayer.mono~.module.maxpat",
				"bootpath" : "/Users/WALL-E/Documents/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/filePlayer~/mono",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
