...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 649.0, 639.0, 69.0, 14.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 649.0, 667.0, 77.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 112.0, 2.0, 70.0, 17.0 ],
					"range" : [ 0.0, 100.0 ],
					"showvalue" : 0,
...
,
					"patching_rect" : [ 566.0, 639.0, 76.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.0, 668.0, 77.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 112.0, 2.0, 70.0, 17.0 ],
					"range" : [ 0.0, 100.0 ],
					"showvalue" : 0,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 995.0, 676.0, 50.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 932.0, 735.0, 36.0, 36.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 932.0, 715.0, 72.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 932.0, 672.0, 56.0, 20.0 ],
					"text" : "route set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 932.0, 693.0, 32.5, 20.0 ],
					"text" : "+ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 998.5, 535.0, 100.0, 20.0 ],
					"text" : "r #0_xxx_audio"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 913.0, 535.0, 74.0, 14.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 281.0, 180.0, 46.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.0, 567.0, 84.0, 13.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.0, 491.5, 84.0, 13.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 566.0, 398.0, 105.0, 20.0 ],
					"text" : "s #0_xxx_record"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 574.0, 218.0, 186.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 922.5, 584.0, 907.0, 584.0, 907.0, 528.0, 922.5, 528.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 941.5, 776.0, 911.5, 776.0, 911.5, 633.0, 941.5, 633.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1008.0, 556.0, 922.5, 556.0 ],
					"source" : [ "obj-5", 0 ]
				}
