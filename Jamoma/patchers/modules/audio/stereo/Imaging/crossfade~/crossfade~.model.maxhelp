...
, 							{
								"box" : 								{
									"args" : [ "@name", "crossfade~.model", "@description", "Module for crossfading between two sound sources" ],
									"bgmode" : 1,
									"id" : "obj-1",
									"maxclass" : "bpatcher",
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 0.0, 0.0, 789.0, 70.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "signal", "signal", "" ],
									"patching_rect" : [ 224.0, 360.0, 300.0, 70.0 ],
...
,
		...
		"dependency_cache" : [ 			{
				"name" : "crossfade~.module.maxpat",
				"bootpath" : "/Users/lossius/dev/Jamoma/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/stereo/crossfade~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
