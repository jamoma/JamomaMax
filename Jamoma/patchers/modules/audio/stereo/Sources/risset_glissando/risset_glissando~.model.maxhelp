...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 145.0, 422.0, 300.0, 175.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 145.0, 177.0, 300.0, 105.0 ],
...
,
		...
		"parameters" : 		{
			...
			"obj-2::obj-2::obj-1::obj-12::obj-30" : [ "live.menu", "live.menu", 0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "risset_glissando~.module.maxpat",
				"bootpath" : "~/dev/Jamoma/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/stereo/Sources/risset_glissando",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
