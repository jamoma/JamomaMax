...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 141.0, 24.5, 5.0, 40.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 134.0, 24.5, 5.0, 40.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 111.125, 397.0, 55.0, 20.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 51.875, 342.5, 49.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 51.875, 377.0, 40.0, 40.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 51.875, 300.0, 119.0, 20.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 22.0, 265.0, 67.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 28.0, 15.0, 44.0, 20.0 ],
									"text" : "Mode"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 212.0, 258.0, 106.0, 20.0 ],
									"text" : "j.remote mode",
									"varname" : "mode[1]"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 212.0, 223.0, 108.0, 20.0 ],
									"text" : "j.remote shape",
									"varname" : "shape[1]"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 22.0, 223.0, 55.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 28.0, 41.0, 49.0, 20.0 ],
									"text" : "Shape"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 83.0, 265.0, 101.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 77.0, 15.0, 112.0, 20.0 ],
									"varname" : "mode"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 83.0, 223.0, 101.0, 20.0 ],
									"presentation" : 1,
...
,
					"patching_rect" : [ 131.0, 84.0, 48.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 61.375, 336.0, 120.625, 336.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 61.375, 426.0, 44.375, 426.0, 44.375, 290.0, 61.375, 290.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 120.625, 433.0, 35.0, 433.0, 35.0, 283.0, 61.375, 283.0 ],
					"source" : [ "obj-27", 0 ]
				}
