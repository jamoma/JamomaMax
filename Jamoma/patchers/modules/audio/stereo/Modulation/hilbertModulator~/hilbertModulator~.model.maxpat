...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter modulatingFrequency @type decimal @range -200. 1000. @clipmode none @ramp/function linear @ramp/drive max @description \"Modulator frequency (Hz). \" @dataspace time @unit Hz"
				}
