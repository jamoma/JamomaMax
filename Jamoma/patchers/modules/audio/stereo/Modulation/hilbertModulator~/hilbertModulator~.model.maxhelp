...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"ignoreclick" : 1,
					"jsarguments" : [ "hilbertModulator~.model" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 79.0, 380.0, 300.0, 175.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 79.0, 90.0, 300.0, 175.0 ],
									"presentation_rect" : [ 15.0, 15.0, 300.0, 175.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "signal", "signal", "" ],
									"patching_rect" : [ 79.0, 282.0, 300.0, 70.0 ],
...
, 							{
								"box" : 								{
									"args" : [ "@name", "hilbertModulator~.model", "@description", "A module for additive synthesis" ],
									"bgmode" : 1,
									"id" : "obj-1",
									"maxclass" : "bpatcher",
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 0.0, 0.0, 474.0, 70.0 ],
									"varname" : "maxhelpui"
								}
...
, 			{
				"name" : "hilbertModulator~.module.maxpat",
				"bootpath" : "/Users/jln/@Jamoma/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/stereo/hilbertModulator~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
