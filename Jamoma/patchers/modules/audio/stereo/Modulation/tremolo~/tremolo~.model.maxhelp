...
, 			{
				"box" : 				{
					"args" : [ "@name", "tremolo~.model", "@description", "Stereo tremolo effect with channel phase offset" ],
					"bgmode" : 1,
					"id" : "obj-1",
					"maxclass" : "bpatcher",
...
, 			{
				"name" : "tremolo~.module.maxpat",
				"bootpath" : "/Users/lossius/dev/Jamoma/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/stereo/Modulation/tremolo~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
