...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter delay/right @type integer @ramp/drive Max @repetitions/filter 1 @range 0 1000000 @clipmode both @dataspace time @dataspace/unit sample @description \"Delay time in samples for right channel.\"",
					"varname" : "delay/right"
				}
