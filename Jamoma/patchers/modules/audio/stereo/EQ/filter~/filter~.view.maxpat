...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.5, 317.0, 113.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.5, 376.0, 113.0, 20.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 25.0, 19.0, 100.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 21.0, 16.0, 129.0, 27.0 ],
									"text" : "Clear filter"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 25.0, 47.0, 83.0, 20.0 ],
									"text" : "j.remote clear"
								}
...
,
					"patching_rect" : [ 0.0, 120.0, 47.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 117.5, 348.0, 154.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 49.166664, 508.0, 110.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 62.0, 45.0, 45.0, 20.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "CenterFreq"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 62.0, 68.0, 45.0, 20.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "Q"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 524.5, 273.0, 154.0, 20.0 ],
					"text" : "j.remote octave_bandwidth",
					"varname" : "q"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 62.0, 22.0, 45.0, 20.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "FilterGain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 45.0, 35.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 45.0, 35.0, 20.0 ],
					"text" : "Freq"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 68.0, 62.0, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 6.0, 68.0, 62.0, 33.0 ],
					"text" : "Bandwth\noctave"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 22.0, 39.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 22.0, 39.0, 20.0 ],
					"text" : "Gain"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 130.166669, 500.0, 268.523804, 500.0, 268.523804, 240.0, 200.214286, 240.0 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 88.999997, 539.0, 284.964294, 539.0, 284.964294, 232.0, 170.928571, 232.0 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 127.0, 402.0, 249.0, 402.0, 249.0, 252.0, 229.5, 252.0 ],
					"source" : [ "obj-8", 0 ]
				}
