...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 93.0, 261.0, 123.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 259.0, 380.0, 116.0, 18.0 ],
									"text" : "threshold -40."
								}
...
,
		...
		"dependency_cache" : [ 			{
				"name" : "noisegate~.module.maxpat",
				"bootpath" : "/Users/bltzr/dev/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/noisegate~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
