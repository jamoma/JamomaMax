...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 263.0, 35.0, 18.0, 20.0 ],
					"text" : ":",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 243.0, 35.0, 18.0, 20.0 ],
					"text" : ":",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"varname" : "sep1_disp"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 268.333313, 35.0, 23.0, 20.0 ],
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "s_disp"
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 250.333344, 35.0, 23.0, 20.0 ],
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "min_disp"
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 229.0, 35.0, 23.0, 20.0 ],
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "h_disp"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "", "" ],
					"patching_rect" : [ 144.0, 281.0, 118.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "", "" ],
					"patching_rect" : [ 144.0, 225.0, 118.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 401.0, 208.0, 71.0, 17.933016 ],
					"presentation" : 1,
					"presentation_rect" : [ 230.0, 35.0, 61.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 76.0, 45.0, 146.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 76.0, 27.0, 146.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 401.0, 183.0, 247.999939, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 409.0, 23.0, 186.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 478.0, 121.0, 109.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 478.0, 85.0, 99.0, 20.0 ],
...
,
					"patching_rect" : [ 401.0, 56.0, 71.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 401.0, 85.0, 61.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 23.0, 60.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 401.0, 121.0, 61.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 45.0, 60.0, 20.0 ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 410.5, 231.0, 386.0, 231.0, 386.0, 172.0, 410.5, 172.0 ],
					"source" : [ "obj-11", 0 ]
				}
