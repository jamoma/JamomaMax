{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 443.0, 93.0, 930.0, 730.0 ],
		"bglocked" : 0,
		"defrect" : [ 443.0, 93.0, 930.0, 730.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 145.0, 39.0, 150.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 760.0, 461.0, 52.0, 19.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "int" ],
					"patching_rect" : [ 35.0, 40.0, 107.0, 19.0 ],
					"text" : "t 1 l 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 670.0, 425.0, 106.0, 19.0 ],
					"text" : "s #1pgm_menu"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 10.0, 59.0, 730.0, 440.0 ],
						"bglocked" : 0,
						"defrect" : [ 10.0, 59.0, 730.0, 440.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "read" ],
									"patching_rect" : [ 164.0, 209.0, 38.0, 19.0 ],
									"text" : "t read"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 200.0, 165.0, 76.0, 19.0 ],
									"text" : "prepend read"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 164.0, 132.0, 51.0, 19.0 ],
									"text" : "sel bang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "writepgm" ],
									"patching_rect" : [ 417.0, 209.0, 63.0, 19.0 ],
									"text" : "t writepgm"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 478.0, 165.0, 100.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 417.0, 132.0, 51.0, 19.0 ],
									"text" : "sel bang"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 278.0, 209.0, 66.0, 19.0 ],
									"text" : "t writebank"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 349.0, 165.0, 71.0, 31.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 278.0, 132.0, 51.0, 19.0 ],
									"text" : "sel bang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 278.0, 98.0, 282.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 575.0, 276.0, 23.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 276.0, 23.0, 23.0 ]
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 173.5, 247.0, 59.5, 247.0 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 401.5, 76.5, 584.5, 76.5 ],
									"source" : [ "obj-14", 3 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-13", 0 ],
									"hidden" : 0,
									"midpoints" : [ 209.5, 249.0, 59.5, 249.0 ],
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-13", 0 ],
									"hidden" : 0,
									"midpoints" : [ 426.5, 255.0, 59.5, 255.0 ],
									"source" : [ "obj-4", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-13", 0 ],
									"hidden" : 0,
									"midpoints" : [ 487.5, 257.0, 59.5, 257.0 ],
									"source" : [ "obj-5", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-13", 0 ],
									"hidden" : 0,
									"midpoints" : [ 287.5, 251.0, 59.5, 251.0 ],
									"source" : [ "obj-7", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-13", 0 ],
									"hidden" : 0,
									"midpoints" : [ 358.5, 253.0, 59.5, 253.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 565.0, 310.0, 136.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 165.0, 225.0, 160.0, 19.0 ],
...
,
					"patching_rect" : [ 98.0, 180.0, 107.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 760.0, 485.0, 27.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 127.0, 204.0, 65.0, 19.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"hidden" : 0,
					"midpoints" : [ 158.5, 165.0, 549.5, 165.0 ],
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"hidden" : 0,
					"midpoints" : [ 166.166672, 457.0, 604.5, 457.0 ],
					"source" : [ "obj-12", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"hidden" : 0,
					"midpoints" : [ 107.5, 240.0, 549.5, 240.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"hidden" : 0,
					"midpoints" : [ 195.5, 211.0, 786.5, 211.0 ],
					"source" : [ "obj-12", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 576.166687, 390.0, 660.0, 390.0, 660.0, 174.0, 195.5, 174.0 ],
					"source" : [ "obj-23", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 589.5, 378.5, 802.5, 378.5 ],
					"source" : [ "obj-23", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 132.5, 73.5, 769.5, 73.5 ],
					"source" : [ "obj-24", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 44.5, 73.5, 769.5, 73.5 ],
					"source" : [ "obj-24", 0 ]
				}
