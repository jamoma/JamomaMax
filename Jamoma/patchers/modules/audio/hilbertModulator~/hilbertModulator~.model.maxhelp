...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 79.0, 380.0, 300.0, 140.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 79.0, 117.0, 300.0, 140.0 ],
									"presentation_rect" : [ 15.0, 15.0, 300.0, 140.0 ]
								}
...
, 			{
				"name" : "hilbertModulator~.module.maxpat",
				"bootpath" : "/Users/tumble/dev/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/hilbertModulator~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
