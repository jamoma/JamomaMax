    ...
    "boxes": [
      ...
      },
      {
        "box": {
          ...
          "text": "j.parameter updaterate @type integer @ramp/drive Max @repetitions/filter 1 @range/bounds 0 240 @range/clipmode low @description \"Sample rate in [Hz] by default\"",
