{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 279.0, 178.0, 897.0, 478.0 ],
		"bglocked" : 0,
		"defrect" : [ 279.0, 178.0, 897.0, 478.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 107.0, 196.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 322.0, 85.0, 33.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 22.0, 34.0, 17.0 ],
					"rounded" : 8.0,
					"text" : "Init",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"id" : "obj-1",
					"items" : [ "NilsPeters-1", ",", "Hi-2", ",", "Bluetooth-Modem", ",", "17thstar-Bluetooth-PDA--1", ",", "Hi-1", ",", "Bluetooth-PDA-Sync" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					...
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 38.0, 22.0, 111.0, 19.0 ],
					"types" : [  ],
					"varname" : "port_menu2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 312.0, 158.0, 35.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 46.0, 29.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "sample_rate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 328.0, 24.0, 33.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 46.0, 34.0, 17.0 ],
					"rounded" : 8.0,
					"text" : "Off",
					"texton" : "On",
					"varname" : "audio"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 136.0, 137.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "clear" ],
					"patching_rect" : [ 170.0, 287.0, 92.0, 19.0 ],
					"text" : "jalg.polhemus"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 125.0, 13.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 222.0, 13.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 21.0, 126.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 33.0, 46.0, 94.0, 19.0 ],
					"text" : "Updaterate [Hz]"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 337.5, 73.0, 315.0, 73.0, 315.0, 19.0, 337.5, 19.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 40.5, 155.0, 18.5, 155.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 321.5, 210.0, 299.0, 210.0, 299.0, 153.0, 321.5, 153.0 ],
					"source" : [ "obj-7", 0 ]
				}
