{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 290.0, 47.0, 410.0, 520.0 ],
		"bglocked" : 0,
		"defrect" : [ 290.0, 47.0, 410.0, 520.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 175.0, 434.0, 44.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "jmod.fileNameGenerator.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 52.5, 427.5, 184.5, 427.5 ],
					"source" : [ "obj-4", 0 ]
				}
