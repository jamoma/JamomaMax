{
	"patcher" : 	{
		...
		"bglocked" : 0,
		"defrect" : [ 480.0, 83.0, 640.0, 480.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 175.0, 172.0, 16.0, 131.0 ],
...
, 							{
								"box" : 								{
									...
									"text" : "j.return master/fader @type integer @range/bounds 0 127 @range/clipmode both @repetitions/filter 0 @description \"Master fader.\"",
									"varname" : "#2/fader"
								}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 181.0, 305.0, 161.0, 305.0, 161.0, 146.0, 184.5, 146.0 ],
					"source" : [ "obj-8", 0 ]
				}
