...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 89.0, 592.0, 19.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 152.0, 72.0, 323.0, 31.0 ],
					"text" : "jmod.cueManager allows to store/recall all (or a portion of) the parameters of all open Jamoma modules as CUEs"
				}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 26.0, 32.0, 588.0, 29.0 ],
													"text" : "In the example cuelist that is loaded with this help patcher, if we select the 'Cue 4' in the menu, all the content of 'Init_Cue'  will be dumped first, excepting the parameters which are present in the next CUEs, which will be replaced by their latest value."
												}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 16.0, 353.0, 18.0 ],
									"text" : "jmod.cueManager is based on the concept of Absolute and Differential CUEs."
								}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 29.0, 34.0, 187.0, 18.0 ],
													"text" : "disable autofollow by pressing the a key"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 130.0, 149.0, 24.0, 19.0 ],
													"text" : "t 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 57.0, 149.0, 24.0, 19.0 ],
													"text" : "t 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 104.0, 149.0, 24.0, 19.0 ],
													"text" : "t 1"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 103.0, 125.0, 63.0, 19.0 ],
													"text" : "sel 97 122"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 33.0, 148.0, 24.0, 19.0 ],
													"text" : "t 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "bang", "bang", "" ],
													"patching_rect" : [ 33.0, 124.0, 67.0, 19.0 ],
													"text" : "sel 97 122"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 103.0, 97.0, 59.5, 19.0 ],
													"text" : "keyup"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "int", "int", "int", "int" ],
													"patching_rect" : [ 33.0, 97.0, 59.5, 19.0 ],
													"text" : "key"
												}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 19.0, 30.0, 552.0, 29.0 ],
									"text" : "• After manually editing a CUE in the text editor, the corresponding CUE will be triggered, in order to reflect the changes of parameters in the patcher"
								}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-7",
					"maxclass" : "bpatcher",
					"name" : "jmod.cueComment.maxpat",
					"numinlets" : 2,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 350.0, 127.0, 300.0, 70.0 ],
					"presentation" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 24.0, 101.333336, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 23.0, 73.333336, 37.0, 18.0 ],
									"text" : "/next"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 23.0, 45.333332, 43.0, 20.0 ],
									"text" : "sel 32"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "int", "int", "int" ],
									"patching_rect" : [ 23.0, 17.0, 59.5, 20.0 ],
									"text" : "key"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.0, 96.0, 163.0, 19.0 ],
					"text" : "loadmess load cuelist_help.txt"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 230.0, 208.0, 155.0, 19.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 36.0, 205.0, 191.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 105.0, 94.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 96.0, 62.0, 17.0 ],
					"text" : "/debug $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 350.0, 399.0, 264.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 127.0, 300.0, 70.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 350.0, 325.0, 290.0, 43.0 ],
					"presentation" : 1,
					"presentation_linecount" : 4,
					"presentation_rect" : [ 350.0, 310.0, 230.0, 55.0 ],
					"text" : "more commands are available in the INSPECTOR (+) : \n- to manage the cue list (copy, remove)\n- to select the module to store in the cuelist"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 350.0, 379.0, 243.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 350.0, 286.0, 287.0, 31.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 350.0, 275.0, 280.0, 31.0 ],
					"text" : "Use the \"Cue___Menu\" to select a cue and dump it. \nHere you can iterate through CUEs with the spacebar"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 350.0, 243.0, 322.0, 31.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 350.0, 223.0, 323.0, 31.0 ],
					"text" : "Cuelist files can be loaded/saved with the upper right menu. \nAn example cuelist is loaded at startup of this help patcher"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 479.0, 300.0, 140.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 249.0, 300.0, 140.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 30.0, 399.0, 300.0, 70.0 ],
					"presentation" : 1,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 44.5, 196.5, 45.5, 196.5 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 1 ],
					"hidden" : 1,
					"midpoints" : [ 44.5, 206.0, 342.5, 206.0, 342.5, 117.0, 640.5, 117.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 1,
					"midpoints" : [ 45.5, 236.0, 421.0, 236.0, 421.0, 118.0, 44.0, 118.0, 44.0, 119.0, 44.5, 119.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 1,
					"midpoints" : [ 232.5, 118.5, 44.5, 118.5 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 1,
					"midpoints" : [ 640.5, 206.0, 342.5, 206.0, 342.5, 117.0, 44.5, 117.0 ],
					"source" : [ "obj-7", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 1,
					"midpoints" : [ 134.5, 119.5, 44.5, 119.5 ],
					"source" : [ "obj-8", 0 ]
				}
