...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 517.0, 177.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 555.0, 491.0, 80.0, 19.0 ],
					"varname" : "CueMenu[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 507.0, 402.0, 177.0, 19.0 ],
					"text" : "clearchecks, checkitem $1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 565.0, 102.0, 129.0, 19.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 191.0, 151.0, 91.0, 19.0 ],
									"text" : "prepend symbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 196.0, 76.0, 20.0 ],
									"text" : "prepend set"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 131.0, 85.0, 19.0 ],
					"text" : "r #0__toHub"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 104.166489, 44.0, 190.743774, 19.0 ],
					"varname" : "CueMenu"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 307.0, 180.0, 83.0, 17.0 ],
									"text" : "setcheck 8226"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 53.5, 110.0, 112.0, 19.0 ],
									"text" : "sel ---END ---START"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "<separator>", "(Select cue)", "clear" ],
									"patching_rect" : [ 100.0, 155.0, 183.0, 19.0 ],
									"text" : "t <separator> \"(Select cue)\" clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 53.5, 85.0, 112.0, 19.0 ],
									"text" : "r #0__set_menu"
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 156.0, 144.0, 64.5, 144.0 ],
									"source" : [ "obj-1", 2 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 316.5, 226.0, 64.5, 226.0 ],
									"source" : [ "obj-23", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 273.5, 226.5, 64.5, 226.5 ],
									"source" : [ "obj-4", 2 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 85.0, 264.0, 115.0, 19.0 ],
					"text" : "jalg.cueScript #0_"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/nilspeters/Documents/gits/Jamoma/Modules/Modular/Max/modules/control/cueScript",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
