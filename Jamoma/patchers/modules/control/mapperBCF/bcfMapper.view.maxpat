...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 74.0, 131.0, 51.0, 17.0 ],
									"text" : "zl ecils 1"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 28.0, 154.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 52.0, 322.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 91.0, 24.0, 32.5, 15.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 39.0, 145.0, 163.0, 17.0 ],
									"text" : "t b clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 39.0, 118.0, 183.0, 17.0 ],
									"text" : "route clear"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 203.0, 203.0, 25.0, 25.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 114.0, 111.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 39.0, 46.0, 32.5, 17.0 ],
									"text" : "sel 1"
								}
...
,
					"patching_rect" : [ 274.0, 38.0, 88.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 9.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 40.0, 80.0, 18.0 ],
					"text" : "sprintf #1/%s"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 117.0, 69.0, 245.0, 20.0 ],
					"prefix" : "/BCF/",
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 24.0, 402.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 367.0, 236.0, 82.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 82.0, 2.0, 82.0, 18.0 ],
					"text" : "directionnality :"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 456.0, 236.0, 44.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 158.0, 3.0, 41.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 170.0, 134.0, 45.0 ],
					"text" : "powerValue $1, function/samples, output/min, output/max"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 111.0, 77.0, 18.0 ],
									"text" : "prepend toggle"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 97.0, 178.0, 63.0, 18.0 ],
									"text" : "prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 40.0, 25.0, 25.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 135.0, 70.0, 25.0, 25.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.0, 37.0, 152.0, 18.0 ],
					"text" : "sprintf setsymbol %s/value"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 91.0, 7.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 463.0, 166.0, 150.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 319.0, 2.0, 43.0, 18.0 ],
					"text" : "power :"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 433.0, 189.0, 87.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 367.0, 2.0, 39.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 696.0, 172.0, 99.0, 89.0 ],
					"peakcolor" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 407.0, 2.0, 70.0, 68.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"size" : 100
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.0, 40.0, 404.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 47.0, 405.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 283.5, 61.5, 126.5, 61.5 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 449.5, 87.0, 427.0, 87.0, 427.0, 36.0, 449.5, 36.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../components/namespaceMenu",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
