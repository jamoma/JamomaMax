	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 436.0, 144.0, 108.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 375.0, 142.0, 48.0, 17.0 ],
					"text" : "bgrd $1"
				}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "j.return buttons @range/bounds 0 3 @type integer @enable 1 @range/clipmode low @description \"buttons of the Wacom tool \""
								}
...
, 							{
								"box" : 								{
									...
									"text" : "j.return touch @range/bounds 0 1 @type boolean @enable 1 @range/clipmode both @description \"Indicates if the tool touches the tablet\""
								}
...
,
					"patching_rect" : [ 428.0, 217.0, 58.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 875.0, 515.0, 291.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 738.0, 414.0, 257.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 546.0, 516.0, 322.0, 43.0 ],
					"text" : "j.return buttons/raw @range/bounds 0 5 @type integer @range/clipmode both @enable 0 @description \"button flags of the Wacom tool (odd when pressed, even when released)\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 559.0, 430.0, 154.0, 67.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 399.0, 416.0, 148.0, 79.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 353.0, 503.0, 195.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 210.0, 434.0, 144.0, 67.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 117.0, 507.0, 209.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 559.0, 352.0, 115.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 147.0, 142.0, 66.0, 17.0 ],
					"text" : "xyrange $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 535.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 82.0, 115.0, 53.0, 19.0 ],
					"text" : "sel b 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 753.0, 283.0, 17.0, 17.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 738.0, 283.0, 17.0, 17.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 738.0, 263.0, 42.0, 19.0 ],
					"text" : "sel 1 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 398.0, 317.0, 150.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 353.0, 344.0, 150.0, 19.0 ],
					"text" : "scale -30720. 30720. -1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 210.0, 318.0, 115.0, 19.0 ],
					"text" : "scale 0. 65535. 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 739.0, 214.0, 153.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 147.0, 168.0, 681.0, 19.0 ],
					"text" : "wacom"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 557.0, 143.0, 197.0, 19.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.0, 142.0, 37.0, 17.0 ],
					"text" : "menu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 142.0, 73.0, 17.0 ],
					"text" : "nopointer $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 353.0, 216.0, 64.0, 19.0 ],
					"text" : "unpack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.0, 142.0, 43.0, 17.0 ],
					"text" : "getinfo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.0, 142.0, 39.0, 17.0 ],
					"text" : "nopoll"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.0, 142.0, 26.0, 17.0 ],
					"text" : "poll"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 48.0, 435.0, 158.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 905.0, 260.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 82.0, 63.0, 561.0, 19.0 ],
					"text" : "j.oscroute /on /xyrange /nopointer /initDevice /bgrd /flusheventqueue /menu"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 916.0, 213.0, 104.0, 43.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 168.928574, 111.0, 156.5, 111.0 ],
					"source" : [ "obj-34", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 246.357147, 114.0, 264.0, 114.0 ],
					"source" : [ "obj-34", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 323.785706, 118.0, 340.5, 118.0 ],
					"source" : [ "obj-34", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 401.214294, 93.0, 384.5, 93.0 ],
					"source" : [ "obj-34", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 478.642853, 93.0, 445.5, 93.0 ],
					"source" : [ "obj-34", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 556.071411, 89.0, 566.5, 89.0 ],
					"source" : [ "obj-34", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 818.5, 198.0, 914.5, 198.0 ],
					"source" : [ "obj-21", 9 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 882.5, 477.0, 884.5, 477.0 ],
					"source" : [ "obj-20", 10 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 869.099976, 253.0, 747.5, 253.0 ],
					"source" : [ "obj-20", 9 ]
				}
