...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 128.0, 27.0, 20.0 ],
									"text" : "iter"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 158.0, 98.0, 20.0 ],
									"text" : "prepend append"
								}
...
,
					"patching_rect" : [ 356.0, 418.0, 87.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 645.5, 377.0, 87.0, 18.0 ],
					"text" : "setcheck 8226"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 645.5, 352.0, 54.0, 20.0 ],
					"text" : "j.init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 334.666687, 389.0, 83.0, 20.0 ],
					"text" : "j.remote cues"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.5, 600.0, 177.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 555.5, 574.0, 80.0, 20.0 ],
					"varname" : "CueMenu[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.5, 482.0, 177.0, 19.0 ],
					"text" : "clearchecks, checkitem $1 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 160.166489, 22.0, 58.374352, 20.0 ],
					"rounded" : 8.0,
					"text" : "Edit with",
					"texton" : "View"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 356.0, 346.0, 137.0, 20.0 ],
					"text" : "j.remote script/edit_with"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 565.0, 102.0, 133.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 356.0, 482.0, 146.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 104.166489, 44.0, 190.743774, 20.0 ],
					"varname" : "CueMenu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 355.0, 210.0, 115.0, 20.0 ],
					"text" : "j.remote script/save"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 355.0, 295.0, 488.0, 20.0 ],
					"text" : "j.remote view"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 100.0, 141.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 355.0, 132.0, 113.0, 20.0 ],
					"text" : "j.remote script/read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 157.0, 291.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 355.0, 66.0, 107.0, 20.0 ],
					"text" : "j.remote get_state",
					"varname" : "j.parameter"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 429.0, 504.5, 365.5, 504.5 ],
					"source" : [ "obj-3", 1 ]
				}
