...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 25.0, 312.5, 100.0, 19.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "condition.view.maxpat",
				"bootpath" : "/Users/bltzr/dev/Jamoma/Implementations/Max/Jamoma/patchers/modules/data/condition",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
