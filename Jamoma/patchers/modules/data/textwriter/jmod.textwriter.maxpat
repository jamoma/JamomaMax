...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 152.0, 96.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 51.0, 100.0, 71.0, 20.0 ],
									"text" : "route name"
								}
...
,
					"patching_rect" : [ 197.0, 175.5, 162.0, 20.0 ],
...
,
					"text" : "p put_Module_name_to_title"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 226.0, 106.0, 55.0, 17.0 ],
					"text" : "getname"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 440.0, 20.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 30.0, 53.0, 19.0 ],
...
, 			{
				"box" : 				{
					"annotation" : "Open the text buffer to view the content",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-15",
					"maxclass" : "textbutton",
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 440.0, 215.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 205.0, 30.0, 40.0, 20.0 ],
					"text" : "Show",
					"texton" : "On"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Write the text buffer to a file",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "textbutton",
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 440.0, 145.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 160.0, 30.0, 40.0, 20.0 ],
					"text" : "Write",
					"texton" : "On"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Clear the text buffer",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-8",
					"maxclass" : "textbutton",
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 440.0, 80.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 250.0, 30.0, 40.0, 20.0 ],
					"text" : "Clear",
					"texton" : "On"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 85.0, 196.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 278.0, 215.0, 15.0, 15.0 ]
				}

			}
, 			{
				"box" : 				{
					"annotation" : "last timestamp",
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 197.0, 352.0, 102.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 70.0, 30.0, 78.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "time"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 105.0, 137.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 197.0, 302.0, 100.0, 19.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 449.5, 68.0, 434.0, 68.0, 434.0, 13.0, 449.5, 13.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jalg.textwriter.maxpat",
				"bootpath" : "/Users/nilspeters/Documents/gits/Jamoma/Modules/Modular/Max/modules/data/textwriter",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
