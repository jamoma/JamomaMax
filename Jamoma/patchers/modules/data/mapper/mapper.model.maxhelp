...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 21.5, 501.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.5, 28.0, 111.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 269.5, 7.0, 156.0, 22.0 ],
					"style" : "",
					"text" : "/degrade~/samplerate_ratio"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 269.5, 51.0, 100.0, 22.0 ],
					"style" : "",
					"text" : "prepend output"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 570.0, 90.0, 22.0 ],
					"style" : "",
					"text" : "1 2 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 545.0, 90.0, 22.0 ],
					"style" : "",
					"text" : "totoEnSlip 123"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.5, 523.0, 90.0, 22.0 ],
					"style" : "",
					"text" : "output/max 10."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 653.0, 50.0, 35.0 ],
					"style" : "",
					"text" : "0.558333"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 21.5, 595.0, 234.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.0, 210.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 152.0, 175.0, 139.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 32.0, 59.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 7.0, 229.0, 49.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 15.0, 320.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.0, 120.0, 450.0, 105.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 88.0, 156.0, 49.0 ],
					"style" : "",
...
, 			{
		...
		"parameters" : 		{
			"obj-4::obj-10::obj-188" : [ "live.text[14]", "live.text[1]", 0 ],
			"obj-3::obj-1::obj-13" : [ "live.dial", "Sample rate", 0 ],
			"obj-19::obj-8" : [ "live.text[15]", "live.text", 0 ],
			"obj-19::obj-10::obj-95" : [ "live.text[8]", "live.text", 0 ],
			"obj-4::obj-10::obj-95" : [ "live.text[12]", "live.text", 0 ],
			"obj-4::obj-10::obj-196" : [ "live.text[11]", "live.text", 0 ],
			"obj-3::obj-1::obj-14" : [ "live.dial[1]", "Bit depth", 0 ],
			"obj-4::obj-8" : [ "live.text[10]", "live.text", 0 ],
			"obj-19::obj-10::obj-174" : [ "live.text[5]", "live.text[1]", 0 ],
			"obj-19::obj-10::obj-188" : [ "live.text[6]", "live.text[1]", 0 ],
			"obj-4::obj-10::obj-174" : [ "live.text[13]", "live.text[1]", 0 ],
			"obj-19::obj-182" : [ "live.text[17]", "live.text[4]", 0 ],
			"obj-4::obj-21" : [ "live.text[9]", "live.text", 0 ],
			"obj-19::obj-10::obj-196" : [ "live.text[7]", "live.text", 0 ],
			"obj-19::obj-10::obj-145" : [ "live.menu[1]", "live.menu", 0 ],
			"obj-4::obj-10::obj-145" : [ "live.menu[2]", "live.menu", 0 ],
			"obj-19::obj-21" : [ "live.text[16]", "live.text", 0 ],
			"obj-4::obj-182" : [ "live.text[4]", "live.text[4]", 0 ]
		}
,
		"dependency_cache" : [ 			{
