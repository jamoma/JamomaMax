...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 500.0, 300.0, 175.0 ],
					"presentation_rect" : [ 22.0, 472.0, 300.0, 175.0 ],
					"varname" : "/input~[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 624.0, 257.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 177.0, 285.0, 19.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 435.0, 400.0, 197.0, 17.0 ],
													"text" : "/input~/audio/amplitude.1:/enable 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 205.0, 95.0, 24.0, 19.0 ],
													"text" : "t b"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 150.0, 280.0, 54.0, 19.0 ],
													"text" : "del 2000"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 150.0, 305.0, 158.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 435.0, 370.0, 197.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 435.0, 195.0, 135.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 435.0, 345.0, 125.0, 17.0 ],
													"text" : "/input~/audio/active 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 435.0, 320.0, 130.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 435.0, 295.0, 119.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 205.0, 125.0, 54.0, 19.0 ],
													"text" : "loadbang"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 210.0, 470.0, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 205.0, 150.0, 50.0, 19.0 ],
													"text" : "qlim"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 435.0, 220.0, 133.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 435.0, 270.0, 83.0, 17.0 ],
													"text" : "/filter~/q 2.55"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 435.0, 245.0, 147.0, 17.0 ],
...
,
					"patching_rect" : [ 146.0, 178.0, 87.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 139.0, 8.0, 270.0, 19.0 ],
									"text" : "allows the user to choose among different  modes :"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 11.0, 88.0, 412.0, 43.0 ],
									"text" : "x-> : \"exclude from cues\" : This mode allows to exclude the output parameter from being retrieved in cues, then avoiding value recalling to interrupt a manual control..."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 11.0, 47.0, 412.0, 43.0 ],
									"text" : "<-> : bi-directionnal maping (when the output parameter is recalled remotely, the input parameter is set to the adequate value - this is useful e.g. for motorized controllers as BCF2000"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 11.0, 28.0, 296.0, 19.0 ],
									"text" : "--> : normal mono-directionnal maping"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 111.0, 7.0, 29.0, 19.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 266.0, 15.0, 27.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 7.0, 100.0, 19.0 ],
									"text" : "the arrows menu "
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 63.0, 108.0, 314.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 154.0, 90.0, 19.0 ],
									"text" : "prepend /*/edit"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 18.0, 111.0, 42.0, 19.0 ],
									"pattrmode" : 1,
									"presentation" : 1,
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 1,
									"midpoints" : [ 39.0, 149.5, 39.5, 149.5 ],
									"source" : [ "obj-30", 1 ]
								}
...
, 			{
				"box" : 				{
					"args" : [ "@name", ".mapperContinuous.model", "@description", "A one-to-one continuous mapper" ],
					"bgmode" : 1,
					"id" : "obj-31",
					"maxclass" : "bpatcher",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 982.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 19.0, 201.5, 300.0, 175.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 19.0, 385.5, 300.0, 105.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 356.0, 159.0, 600.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 136.0, 285.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 70.0, 309.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 356.0, 88.0, 600.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 600.0, 70.0 ],
					"varname" : "/mapper"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-1::obj-100" : [ "live.text[2]", "live.text[1]", 0 ],
			"obj-2::obj-1::obj-106" : [ "live.dial[3]", "Release", 0 ],
			"obj-2::obj-1::obj-104" : [ "live.dial[1]", "Depth", 0 ],
			"obj-2::obj-1::obj-108" : [ "live.text[4]", "live.text[4]", 0 ],
			"obj-2::obj-1::obj-97" : [ "live.numbox", "CPU", 0 ],
			"obj-2::obj-1::obj-103" : [ "live.text[3]", "live.text", 0 ],
			"obj-2::obj-1::obj-102" : [ "live.text", "live.text", 0 ],
			"obj-2::obj-1::obj-111" : [ "live.numbox[2]", "live.numbox[2]", 0 ],
			"obj-2::obj-1::obj-107" : [ "live.dial[4]", "Preamp", 0 ],
			"obj-2::obj-1::obj-90" : [ "live.text[1]", "live.text[1]", 0 ],
			"obj-2::obj-1::obj-110" : [ "live.numbox[1]", "live.numbox[1]", 0 ],
			"obj-2::obj-1::obj-98" : [ "live.menu[1]", "live.menu", 0 ],
			"obj-2::obj-1::obj-99" : [ "live.menu[2]", "live.menu[2]", 0 ],
			"obj-2::obj-1::obj-53" : [ "Master Gain", "Master Gain", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "mouse.module.maxpat",
...
, 			{
				"name" : "filter~.module.maxpat",
				"bootpath" : "/Users/reno/Documents/GITs/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/stereo/EQ/filter~",
...
, 			{
				...
				"bootpath" : "/Users/reno/Documents/GITs/Jamoma/Implementations/Max/Jamoma/patchers/components/audio/octavebandwith2q",
...
, 			{
				...
				"bootpath" : "/Users/reno/Documents/GITs/Jamoma/Implementations/Max/Jamoma/patchers/components/audio/q2octavebandwith",
...
, 			{
				"name" : "output~.module.maxpat",
				"bootpath" : "/Users/reno/Documents/GITs/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/stereo/Output/output~",
...
, 			{
				...
				"bootpath" : "/Users/reno/Documents/GITs/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/stereo/Distortion/saturation~",
...
, 			{
				...
				"bootpath" : "/Users/reno/Documents/GITs/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/stereo/Output/record~",
