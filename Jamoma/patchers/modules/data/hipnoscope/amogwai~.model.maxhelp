...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 927.0, 559.0, 300.0, 105.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 70.0, 508.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 975.0, 59.0, 279.0, 260.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 964.5, 331.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 70.0, 20.0, 600.0, 280.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 713.0, 120.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 713.0, 155.0, 181.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 70.0, 658.0, 45.0, 45.0 ],
					"style" : ""
				}
...
,
					...
					"patching_rect" : [ 70.0, 360.0, 450.0, 71.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 70.0, 466.0, 153.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"grad2" : [ 0.682032, 0.698052, 0.748716, 1.0 ],
					"id" : "obj-6",
					"maxclass" : "panel",
					"mode" : 1,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 960.0, 48.0, 310.0, 359.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 722.5, 187.0, 690.5, 187.0, 690.5, 109.0, 722.5, 109.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-9::obj-31::obj-29" : [ "live.menu[1]", "live.menu", 0 ],
			"obj-12::obj-15" : [ "Postamp", "Postamp", 0 ],
			"obj-5::obj-6::obj-31::obj-29" : [ "live.menu", "live.menu", 0 ],
			...
			"obj-12::obj-30" : [ "live.menu[2]", "live.menu", 0 ],
			"obj-9::obj-10" : [ "live.text[1]", "live.text", 0 ],
			"obj-8::obj-4" : [ "live.dial[1]", "Freq shift", 0 ],
			"obj-12::obj-42" : [ "live.text[3]", "live.text", 0 ],
			"obj-12::obj-6" : [ "live.text[4]", "live.text", 0 ],
