...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 435.0, 113.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-5",
					"items" : [ "<separator>", ",", "(", "parameters", ":)", ",", "address", ",", "dir", ",", "enable", ",", "power", ",", "value", ",", "<separator>", ",", "(", "messages", ":)", ",", "<separator>", ",", "(", "returns", ":)", ",", "<separator>" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
