{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 219.0, 120.0, 410.0, 297.0 ],
		"bglocked" : 0,
		"defrect" : [ 219.0, 120.0, 410.0, 297.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 399.0, 226.0, 76.0, 19.0 ],
					"text" : "prepend help"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 399.0, 251.0, 51.0, 19.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.0, 246.0, 37.0, 17.0 ],
					"text" : "jit.op"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 331.0, 225.0, 57.0, 19.0 ],
					"text" : "See also:"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "j.op", "@description", "For all those times you wished you could use jit.op for numbers" ],
					"bgmode" : 1,
					"id" : "obj-19",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 83.0, 108.0, 60.0, 19.0 ],
					"pattrmode" : 1,
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 197.0, 108.0, 37.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 30.0, 108.0, 37.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 223.0, 159.0, 124.0, 31.0 ],
