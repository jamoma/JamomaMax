...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 18.0, 163.0, 100.0, 19.0 ],
					"text" : "b 2"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "j.spray%", "@description", "Distribute a video over multiple outlets" ],
					"bgmode" : 1,
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 840.0, 70.0 ],
					"varname" : "maxhelpui"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 300.0, 155.0, 19.0 ],
					"text" : "j.autosize% @width 800"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 18.0, 327.0, 800.0, 300.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 18.0, 272.0, 173.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 18.0, 127.0, 123.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 18.0, 239.0, 173.0, 19.0 ],
					"text" : "j.spray%"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 199.0, 81.0, 123.0, 19.0 ],
					"text" : "movie%.model",
					"varname" : "/input%"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 208.5, 230.0, 150.0, 230.0, 150.0, 230.0, 27.5, 230.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 27.5, 331.0, 27.5, 331.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 108.5, 192.0, 186.0, 192.0, 186.0, 78.0, 208.5, 78.0 ],
					"source" : [ "obj-4", 1 ]
				}
...
, 			{
				"name" : "j.spray%.maxpat",
				"bootpath" : "/Users/reno/JamomaMax/Jamoma/patchers/components/video/spray%",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
