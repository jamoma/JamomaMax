...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 25.0, 95.0, 123.0, 19.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@name", "j.autosize%", "@description", "Resize the output window from incoming video" ],
					"bgmode" : 1,
					"id" : "obj-13",
					"maxclass" : "bpatcher",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 846.0, 70.0 ],
					"varname" : "maxhelpui"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 531.0, 283.0, 306.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 645.0, 89.0, 170.0, 19.0 ],
					"text" : "j.autosize% @width 120"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 645.0, 114.0, 120.0, 160.0 ],
					"presentation_rect" : [ 0.0, 0.0, 120.0, 160.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 89.0, 172.0, 19.0 ],
					"text" : "j.autosize% @height 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 450.0, 114.0, 75.0, 100.0 ],
					"presentation_rect" : [ 0.0, 0.0, 75.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 84.0, 109.0, 67.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 25.0, 122.0, 300.0, 105.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 511.0, 341.0, 60.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 250.0, 99.0, 19.0 ],
					"text" : "j.autosize%"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 25.0, 275.0, 480.0, 640.0 ],
					"presentation_rect" : [ 0.0, 0.0, 480.0, 640.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 511.0, 385.0, 170.0, 43.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 34.5, 241.0, 631.5, 241.0, 631.5, 79.0, 654.5, 79.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 34.5, 241.0, 441.0, 241.0, 441.0, 79.0, 459.5, 79.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 34.5, 241.0, 520.5, 241.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"name" : "orsize%.module.maxpat",
				"bootpath" : "/Users/reno/JamomaMax/Jamoma/patchers/modules/video/fx/orsize%",
				"patcherrelativepath" : "../../../modules/video/fx/orsize%",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
