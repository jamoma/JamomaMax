{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 348.0, 101.0, 501.0, 769.0 ],
		"bglocked" : 0,
		"defrect" : [ 348.0, 101.0, 501.0, 769.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 530.0, 37.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 189.0, 618.0, 69.0, 19.0 ],
					"text" : "prepend"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 189.0, 670.0, 37.0, 19.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.0, 505.0, 70.0, 19.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "This component is used by j.message.array, and create one j.message instance that will be part of an array."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 105.0, 565.0, 187.0, 19.0 ],
					"text" : "j.message #0_ @type integer"
				}
