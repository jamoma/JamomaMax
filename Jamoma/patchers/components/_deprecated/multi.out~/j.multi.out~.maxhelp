...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 142.0, 398.0, 25.0 ],
					"text" : "j.multi.out~ is deprecated. Use j.unpack≈ instead",
...
, 			{
				"box" : 				{
					"args" : [ "@name", "j.multi.out~", "@description", "This", "object", "is", "deprecated" ],
					"bgmode" : 1,
					"id" : "obj-37",
					"maxclass" : "bpatcher",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 493.0, 70.0 ],
					"varname" : "maxhelpui"
				}
