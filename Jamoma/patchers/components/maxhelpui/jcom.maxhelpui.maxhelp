	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "jcom.maxhelpui is a simple utility to be used as a bpatcher, displaying the name and description of the object presented in the help patch. It takes one attributes (@description) defining the description of the object. The name (here jcom.ui) will be set automatically according to the name of the maxhelp file."
				}
