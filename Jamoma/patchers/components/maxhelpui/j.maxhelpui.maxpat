...
"id" : "obj-34",
"ignoreclick" : 1,
"items" : [ ",", "Launch html reference page for j.message", ",", "Launch Jamoma overview patch", ",", "Credits and acknowledgements", ",", "Show the bug tracker entries for j.message", ",", "How to report a bug?", ",", "Paypal donation via pledgie.com" ],
"maxclass" : "umenu",
"numinlets" : 1,
"numoutlets" : 3,
"outlettype" : [ "int", "", "" ],
...
"text" : "patcherargs @name j.module @description \"A module which does a lot of cool things\""
}
