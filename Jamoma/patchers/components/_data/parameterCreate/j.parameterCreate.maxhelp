...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.0, 327.0, 354.0, 19.0 ],
					"presentation_rect" : [ 158.0, 328.0, 0.0, 0.0 ],
					"text" : "connect it to j.model in order to generate presets & documentation"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 58.0, 327.0, 100.0, 19.0 ],
					"text" : "j.model"
				}
