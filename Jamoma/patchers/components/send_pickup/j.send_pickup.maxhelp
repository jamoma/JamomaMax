...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.5, 87.0, 303.0, 47.0 ],
					"text" : "when working with external controllers, it is sometimes useful to prevent the controller from moving the value until it has reached its current state, a.k.a. picking it up"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "j.remote_pickup", "@description", "Allow pickup mode for an external controller" ],
					"bgmode" : 1,
					"id" : "obj-22",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 27.5, 233.0, 41.0, 20.0 ],
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 27.5, 313.0, 138.0, 36.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 30.5, 356.0, 100.0, 20.0 ],
					"text" : "j.remote fxw"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 27.5, 441.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 27.5, 144.0, 46.0, 17.0 ],
					"text" : "ctlin"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 27.5, 178.0, 142.0, 44.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 37.0, 357.0, 40.0, 357.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 40.0, 386.0, 20.0, 386.0, 20.0, 303.0, 37.0, 303.0 ],
					"source" : [ "obj-5", 0 ]
				}
