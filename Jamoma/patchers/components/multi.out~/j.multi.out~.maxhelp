...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 607.0, 454.0, 100.0, 50.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 524.5, 454.0, 100.0, 50.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "j.multi.out~", "@description", "Split audio signals from a multicable" ],
					"bgmode" : 1,
					"id" : "obj-37",
					"maxclass" : "bpatcher",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 749.0, 70.0 ],
					"varname" : "maxhelpui"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 671.0, 373.0, 37.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 424.5, 454.0, 100.0, 50.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 454.0, 100.0, 50.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 324.5, 454.0, 100.0, 50.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 32,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 130.0, 404.0, 527.0, 19.0 ],
					"text" : "j.multi.out~ -4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 309.0, 240.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 329.0, 294.0, 19.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 680.5, 401.0, 647.5, 401.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 188.661285, 436.0, 434.0, 436.0 ],
					"source" : [ "obj-22", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 155.8871, 448.0, 234.5, 448.0 ],
					"source" : [ "obj-22", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 172.2742, 441.0, 334.0, 441.0 ],
					"source" : [ "obj-22", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 205.048386, 432.0, 534.0, 432.0 ],
					"source" : [ "obj-22", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 221.435486, 430.0, 616.5, 430.0 ],
					"source" : [ "obj-22", 5 ]
				}
