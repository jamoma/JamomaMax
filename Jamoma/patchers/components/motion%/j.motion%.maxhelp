{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 34.0, 69.0, 644.0, 465.0 ],
		"bglocked" : 0,
		"defrect" : [ 34.0, 69.0, 644.0, 465.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 522.0, 466.0, 78.0, 19.0 ],
					"text" : "prepend help"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 522.0, 491.0, 55.0, 19.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 522.0, 421.0, 56.0, 19.0 ],
					"text" : "see also:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 522.0, 441.0, 91.0, 17.0 ],
					"text" : "jmod.motion%"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 313.5, 160.0, 32.5, 160.0 ],
					"source" : [ "obj-12", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 313.5, 172.0, 202.5, 172.0 ],
					"source" : [ "obj-12", 1 ]
				}
