...
, 			{
				"box" : 				{
					"args" : [ "@name", "j.send_pickup", "@description", "Allow pickup mode for an external controller" ],
					"bgmode" : 1,
					"id" : "obj-22",
					"maxclass" : "bpatcher",
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/jln/@Jamoma/Jamoma/Implementations/Max/Jamoma/patchers/components/data/send_pickup",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
