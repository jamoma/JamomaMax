...
,
					"patching_rect" : [ 171.0, 41.0, 27.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"id" : "obj-19",
									"ignoreclick" : 1,
									"jsarguments" : [ "j.initialized" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 6.0, 26.0, 536.5, 137.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 227.0, 652.0, 193.0, 60.0 ],
									"style" : "default",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 24.0, 678.0, 181.0, 22.0 ],
									"style" : "default",
									"text" : "print /mice_Initialized @popup 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 24.0, 652.0, 159.0, 22.0 ],
									"style" : "default",
...
,
					"patching_rect" : [ 8.0, 7.0, 50.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
