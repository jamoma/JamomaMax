...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "@name", "j.namespace-selector", "@description", "Report Jamoma absolute path" ],
					"bgmode" : 1,
					"id" : "obj-19",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					"args" : [ "events-namespace" ],
					"id" : "obj-2",
					"maxclass" : "bpatcher",
					"name" : "j.namespace_selector.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 80.0, 382.0, 247.0 ]
				}
