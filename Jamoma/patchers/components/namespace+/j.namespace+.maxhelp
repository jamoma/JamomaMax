...
, 			{
				"box" : 				{
					...
					"text" : "j.namespace+ @lookfor j.parameter @restrict/tags generic"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.namespace+ @lookfor j.parameter @exclude/tags generic"
				}
...
, 							{
								"box" : 								{
									...
									"text" : "j.namespace+ j.hub @exclude/keys mo (view)"
								}
...
, 			{
				"box" : 				{
					...
					"text" : "j.namespace+ @lookfor j.parameter @restrict/keys out"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.namespace+ @lookfor j.parameter @sort priority"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "j.namespace+", "@description", "a patcher-based extension of j.namespace to prototype features" ],
					"bgmode" : 1,
					"id" : "obj-36",
					"maxclass" : "bpatcher",
