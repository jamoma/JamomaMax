{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 25.0, 69.0, 706.0, 496.0 ],
		"bglocked" : 0,
		"defrect" : [ 25.0, 69.0, 706.0, 496.0 ],
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 144.0, 131.0, 77.0, 17.0 ],
									"text" : "size $1, 0 $2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 131.0, 76.0, 19.0 ],
									"text" : "prepend text"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 144.0, 210.0, 25.0, 25.0 ]
								}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "j.webservice", "@description", "Control Web Sharing from Jamoma" ],
					"bgmode" : 1,
					"id" : "obj-18",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 75.0, 260.0, 20.0, 20.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 84.5, 321.5, 119.5, 321.5 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 119.5, 286.0, 84.5, 286.0 ],
					"source" : [ "obj-8", 0 ]
				}
