{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 40.0, 57.0, 668.0, 471.0 ],
		"bglocked" : 0,
		"defrect" : [ 40.0, 57.0, 668.0, 471.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "@name", "j.binary%", "@description", "Create a binary image" ],
					"bgmode" : 1,
					"id" : "obj-15",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 304.0, 375.0, 60.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 488.0, 248.0, 170.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 529.0, 195.0, 35.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 304.0, 245.0, 160.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 304.0, 220.0, 244.0, 19.0 ],
					"text" : "j.binary% @mode negative @threshold 10"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 313.5, 166.0, 34.5, 166.0 ],
					"source" : [ "obj-8", 1 ]
				}
