...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 59.0, 387.0, 19.0 ],
					"style" : "",
					"text" : "Capture a GL texture from Syphon protocol."
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-5",
					"ignoreclick" : 1,
					"jsarguments" : [ "syphonclient" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 4.0, 4.0, 450.0, 71.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 316.0, 296.5, 109.0, 38.0 ],
					"style" : "",
					"text" : "select app & server"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 26.0, 305.0, 100.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 26.0, 190.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 26.0, 223.0, 183.0, 35.0 ],
					"style" : "",
...
,
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 16.0, 131.0, 152.0, 35.0 ],
					"style" : "",
					"text" : "jit.world syphonclient_help @enable 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.0, 99.0, 86.0, 22.0 ],
					"style" : "",
					"text_width" : 65.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 235.5, 223.0, 300.0, 70.0 ],
