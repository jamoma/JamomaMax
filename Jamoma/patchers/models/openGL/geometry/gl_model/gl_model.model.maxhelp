...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "Read and draw various 3D model formats."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 11.0, 128.5, 107.0, 22.0 ],
									"style" : "",
									"text" : "preset:recall duck"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 11.0, 105.0, 141.0, 22.0 ],
									"style" : "",
									"text" : "j.initialized /gl_model"
								}
...
, 							{
								"box" : 								{
									"annotation" : "Read and draw various 3D model formats",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-13",
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 1,
									"maxclass" : "bpatcher",
									"name" : "gl_model.view.maxpat",
									"numinlets" : 1,
									"numoutlets" : 1,
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 212.0, 163.0, 300.0, 280.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 212.0, 79.0, 313.0, 74.0 ],
									"style" : "",
									"text" : "Reads and draws a variety of 3D model formats, such as OBJ, Collada, and Blender. Only tessellated polygons are drawn, and surfaces that are not tessellated are converted before drawing. Certain model formats, such as Collada, support skinned animation.",
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-34::obj-9::obj-36" : [ "live.text", "live.text", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "gl_model.view.maxpat",
				"bootpath" : "~/Documents/GITHUB/JamomaMax/Jamoma/patchers/models/openGL/geometry/gl_model",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
