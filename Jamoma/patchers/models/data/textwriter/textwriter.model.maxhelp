...
, 			{
				"box" : 				{
					"annotation" : "Write data to a text file with a timestamp for each value.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-12",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 237.0, 100.0, 21.0 ],
					"style" : "",
					"text" : "textwriter.model"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 760.0, 546.0, 25.0, 21.0 ],
					"style" : "",
					"text" : "coll"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 726.0, 546.0, 29.0, 21.0 ],
					"style" : "",
					"text" : "text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 726.0, 570.0, 74.0, 21.0 ],
					"style" : "",
					"text" : "prepend help"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 726.0, 590.0, 49.0, 21.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
,
					"patching_rect" : [ 34.0, 99.0, 88.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 34.0, 140.0, 293.0, 81.0 ],
					"peakcolor" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 10,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 34.0, 357.0, 300.0, 70.0 ],
