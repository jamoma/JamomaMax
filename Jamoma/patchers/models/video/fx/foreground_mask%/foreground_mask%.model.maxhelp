...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 203.0, 101.5, 233.0, 28.0 ],
					"style" : "",
					"text" : "need external cv.jit.ravg"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "foreground_mask%.module.maxpat",
				"bootpath" : "~/Documents/GITs/JamomaMax/Jamoma/patchers/models/video/fx/foreground_mask%",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
