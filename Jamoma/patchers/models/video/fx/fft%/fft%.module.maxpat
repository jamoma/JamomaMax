...
, 			{
				"box" : 				{
					"annotation" : "Perform Fast Fourier transform on incoming 1 plane image.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-4",
					"maxclass" : "newobj",
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/reno/Documents/GITs/Jamoma/Implementations/Max/Jamoma/patchers/modules/video/fft%",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
