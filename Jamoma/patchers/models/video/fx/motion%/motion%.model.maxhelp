...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 690.0, 84.0, 221.0, 359.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.0, 468.0, 293.0, 116.0 ],
...
,
					"patching_rect" : [ 54.0, 586.0, 181.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 21.0, 78.0, 121.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 21.0, 198.0, 320.0, 240.0 ]
				}
...
,
					"patching_rect" : [ 367.0, 167.0, 87.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 281.0, 438.0, 64.0, 20.0 ],
					"text" : "route 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 630.0, 169.0, 60.0, 19.0 ],
					"text" : "route 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 665.0, 198.0, 20.0, 240.0 ],
					"peakcolor" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
					"setminmax" : [ 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 346.0, 437.0, 320.0, 20.0 ],
					"peakcolor" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
					"setminmax" : [ 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 346.0, 198.0, 320.0, 240.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 346.0, 86.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 454.0, 167.0, 158.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.0, 468.0, 305.0, 140.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 30.5, 166.0, 333.0, 166.0, 333.0, 82.0, 355.5, 82.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "motion%.module.maxpat",
				"bootpath" : "/Users/reno/JamomaMax/Jamoma/patchers/modules/video/fx/motion%",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				...
				"bootpath" : "/Users/reno/JamomaMax/Jamoma/patchers/components/video/checkplanes%",
...
, 			{
				...
				"bootpath" : "/Users/reno/JamomaMax/Jamoma/patchers/components/data/autoscale",
...
, 			{
				...
				"bootpath" : "/Users/reno/JamomaMax/Jamoma/patchers/components/video/passmatrixinfo%",
...
, 			{
				...
				"bootpath" : "/Users/reno/JamomaMax/Jamoma/media/motiontracking-videos",
				"patcherrelativepath" : "../../../../../media/motiontracking-videos",
				"type" : "JPEG",
				"implicit" : 1
			}
, 			{
