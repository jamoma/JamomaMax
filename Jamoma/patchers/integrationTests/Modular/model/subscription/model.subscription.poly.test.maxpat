...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal poly.deferlow-test @input / @compareTo 3 tester.1 tester.2 tester.3"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal poly-test @input / @compareTo nothing"
								}
