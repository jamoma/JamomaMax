...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 679.0, 343.0, 156.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 883.5, 499.5, 85.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 702.5, 499.5, 89.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 864.0, 168.5, 70.0, 49.0 ],
					"style" : "default",
					"text" : "-1. -1. -1., 0.9 0.2 7. ramp 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 864.0, 228.0, 129.0, 102.0 ],
					"style" : "",
					"text" : "j.parameter test.3 @type array @ramp/drive max @ramp/function linear @dataspace position @unit xyz @repetitions/filter 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 679.0, 125.5, 72.0, 22.0 ],
					"style" : "",
					"text" : "pack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 679.0, 168.5, 90.0, 49.0 ],
					"style" : "default",
					"text" : "-1. -1. -1. xyz, 0.9 0.2 7. xyz ramp 200"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "test.assert Jamoma/Modular/j.parameter/type_array/ramp_and_dataspace/overriding_unit @tags Jamoma Modular j.parameter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 679.0, 228.0, 135.0, 102.0 ],
					"style" : "",
					"text" : "j.parameter test.2 @type array @ramp/drive max @ramp/function linear @dataspace position @unit aed @repetitions/filter 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 679.0, 61.5, 72.0, 22.0 ],
					"style" : "",
					"text" : "t -24. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 732.0, 92.5, 41.0, 22.0 ],
					"style" : "",
					"text" : "dbtoa"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 679.0, 92.5, 41.0, 22.0 ],
					"style" : "",
					"text" : "dbtoa"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.5, 498.5, 33.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "test.assert Jamoma/Modular/j.parameter/type_array/ramp_and_dataspace/default_unit @tags Jamoma Modular j.parameter"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "j.parameter test.1 @type array @ramp/drive max @ramp/function linear @dataspace gain @unit db @repetitions/filter 0"
				}
