...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 243.0, 248.0, 44.0 ],
					"style" : "default",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 146.0, 245.0, 336.0, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "int" ],
									"patching_rect" : [ 70.0, 170.0, 46.0, 20.0 ],
									"style" : "",
									"text" : "t 0 l 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.0, 245.0, 54.0, 20.0 ],
									"style" : "",
									"text" : "gate 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 535.0, 370.0, 39.0, 20.0 ],
									"style" : "",
									"text" : "zl len"
								}
...
,
									"patching_rect" : [ 70.0, 135.0, 132.0, 20.0 ],
...
,
									"patching_rect" : [ 240.0, 160.0, 132.0, 20.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"fontname" : "Ariel",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 385.0, 45.0, 20.0 ],
									"style" : "",
									"text" : "zl sum"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 350.0, 81.0, 20.0 ],
									"style" : "",
									"text" : "vexpr $f1*$f1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 310.0, 53.0, 20.0 ],
									"style" : "",
									"text" : "zl group"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 70.0, 270.0, 57.0, 20.0 ],
									"style" : "",
									"text" : "zl slice 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 240.0, 205.0, 252.0, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 535.0, 465.0, 25.0, 25.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 270.0, 147.0, 287.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 538.0, 188.0, 35.0, 20.0 ],
					"style" : "default",
					"text" : "== 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 188.0, 165.0, 20.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 68.0, 33.0, 20.0 ],
					"style" : "default",
					"text" : "qlim"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 135.0, 95.0, 34.0, 20.0 ],
					"style" : "default",
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 135.0, 38.0, 60.0, 20.0 ],
					"style" : "default",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 306.0, 83.0, 20.0 ],
					"style" : "default",
					"text" : "test.terminate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 538.0, 243.0, 255.0, 44.0 ],
					"style" : "default",
