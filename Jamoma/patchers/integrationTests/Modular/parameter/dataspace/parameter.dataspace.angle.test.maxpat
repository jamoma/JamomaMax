...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal radian>degree-test @input 1.5 radian @compareTo 85.943672 @tolerance 0.000001"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal degree>radian-test @input 60 degree @compareTo 1.047198 @tolerance 0.000001"
								}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter test @type decimal @dataspace angle"
				}
