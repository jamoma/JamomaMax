...
, 			{
				"box" : 				{
					...
					"text" : "j.namespace @filter/list parameter noGenericTag"
				}
...
, 							{
								"box" : 								{
									...
									"text" : "j.test.assert.equal model.deferlow-test @input /testpatcher @compareTo 1 test"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "j.test.assert.equal model-test @input /testpatcher @compareTo nothing"
								}
