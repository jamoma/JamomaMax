...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 489.0, 68.001831, 340.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 68.5, 819.106812, 92.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 28.0, 608.001831, 346.0, 20.0 ],
									"text" : "jcom.test.assert.equal dec-test @input dec 2 @compareTo -0.2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 28.0, 430.001862, 334.0, 20.0 ],
									"text" : "jcom.test.assert.equal inc-test @input inc 2 @compareTo 0.2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 28.0, 246.001862, 306.0, 20.0 ],
									"text" : "jcom.test.assert.equal --test @input - @compareTo -0.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 28.0, 68.001862, 308.0, 20.0 ],
									"text" : "jcom.test.assert.equal +-test @input + @compareTo 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal value/stepsize-test @input value/stepsize @compareTo 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal type-test @input type @compareTo decimal"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 188.0, 160.0, 125.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 8.0, 136.0, 199.0, 20.0 ],
