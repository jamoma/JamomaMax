...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal float-test @input 3.141593 @compareTo 3"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal dec-test @input dec 2 @compareTo -2"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal inc-test @input inc 2 @compareTo 2"
								}
