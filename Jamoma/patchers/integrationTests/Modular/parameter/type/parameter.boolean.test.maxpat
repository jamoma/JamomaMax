...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal list-test @input foo bar ? @compareTo nothing"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal symbol-test @input \"foo bar ?\" @compareTo nothing"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal float-test @input 3.141593 @compareTo 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal integer-test @input 3 @compareTo 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal bang-test @input bang @compareTo 0"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal reset-test @input reset @compareTo 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal dec-test @input dec 2 @compareTo 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal inc-test @input inc 2 @compareTo 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal --test @input - @compareTo 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal type-test @input type @compareTo boolean"
								}
