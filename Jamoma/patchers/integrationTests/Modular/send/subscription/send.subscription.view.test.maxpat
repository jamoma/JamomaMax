...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal view.command-test @input test 1 2.5 foo \"bar thing\" @compareTo 1 2.5 foo \"bar thing\""
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.test.assert.equal view-test @input dump @compareTo /testpatcher(view):value"
								}
