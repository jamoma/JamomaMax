...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 144.0, 415.0, 49.0, 22.0 ],
					"style" : "default",
					"text" : "test.log"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 358.0, 46.0, 22.0 ],
					"style" : "default",
					"text" : "error 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 386.0, 307.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 286.0, 264.0, 49.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 45.0, 256.0, 24.0, 22.0 ],
					"style" : "default",
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 144.0, 200.0, 47.0, 22.0 ],
					"style" : "default",
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 144.0, 70.0, 47.0, 22.0 ],
					"style" : "default",
					"text" : "t b b 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 239.0, 165.0, 25.0, 22.0 ],
					"style" : "default",
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 239.0, 140.0, 78.0, 22.0 ],
					"style" : "default",
					"text" : "route jbogus"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 194.0, 115.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 144.0, 35.300003, 60.0, 22.0 ],
					"style" : "default",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 286.0, 83.0, 22.0 ],
					"style" : "default",
					"text" : "test.terminate"
				}
